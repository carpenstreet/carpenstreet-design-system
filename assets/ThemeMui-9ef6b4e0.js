...
`,At=["none","0px 1px 3px 0px rgba(0, 0, 0, 0.12)","0px 24px 48px 0px rgba(0, 0, 0, 0.08)","-40px 40px 80px -8px rgba(0, 0, 0, 0.12)","0px 1px 18px 0px rgba(0, 0, 0, 0.12), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 3px 5px -1px rgba(0, 0, 0, 0.20)","","","","","","","","","","","","","","","","","","","",""];function Oe({children:U}){const e=na({palette:{...ua,default:{main:"#fff",light:"#fff",dark:"#fff"},gray:{main:"#fff",light:"#fff",dark:"#fff"}},components:{MuiCssBaseline:{styleOverrides:Mt},MuiUseMediaQuery:{defaultProps:{noSsr:!0}},MuiTypography:{styleOverrides:{root:{letterSpacing:"0"}}},MuiButton:{defaultProps:{disableRipple:!0},styleOverrides:{root:({ownerState:a})=>({minWidth:"auto",textTransform:"none",boxShadow:"none","&:hover":{boxShadow:"none"},"& > .MuiButton-startIcon":{marginRight:"4px"},"& > .MuiButton-endIcon":{marginLeft:"4px"},...(a.size==="XL"||a.size==="L")&&{"& > .MuiButton-icon":{"& > svg":{width:"24px",height:"24px"}}},...a.size==="M"&&{"& > .MuiButton-icon":{"& > svg":{width:"20px",height:"20px"}}},...a.size==="S"&&{"& > .MuiButton-icon":{"& > svg":{width:"16px",height:"16px"}}},boxSizing:"border-box",display:"flex",justifyContent:"center",alignItems:"center"}),contained:({ownerState:a,theme:f})=>({"& > .MuiTypography-root":{color:f.palette["color/white"]},...(a.size==="L"||a.size==="XL")&&{borderRadius:"8px",paddingLeft:"22px",paddingRight:"22px",height:"48px"},...a.size==="M"&&{borderRadius:"8px",paddingLeft:"22px",paddingRight:"22px",height:"40px"},...a.size==="S"&&{borderRadius:"4px",paddingLeft:"8px",paddingRight:"8px",height:"24px"},"& > .MuiButton-icon":{"& path, & circle":{fill:f.palette["color/white"]},"& rect":{stroke:f.palette["color/white"]}},...a.color==="primary"&&{backgroundColor:f.palette["color/primary/600"],"&:hover":{backgroundColor:f.palette["color/primary/700"]}},...(a.color==="default"||a.color==="gray")&&{backgroundColor:f.palette["color/gray/800"],"&:hover":{backgroundColor:f.palette["color/gray/600"]}},"&.Mui-disabled":{"& > .MuiTypography-root":{color:f.palette["color/gray/400"]},backgroundColor:f.palette["color/gray/200"],"& > .MuiButton-icon":{"& path, & circle":{fill:f.palette["color/gray/400"]},"& rect":{stroke:f.palette["color/gray/400"]}}}}),outlined:({ownerState:a,theme:f})=>({...(a.size==="L"||a.size==="XL")&&{borderRadius:"8px",paddingLeft:"21px",paddingRight:"21px",height:"48px"},...a.size==="M"&&{borderRadius:"8px",paddingLeft:"21px",paddingRight:"21px",height:"40px"},...a.size==="S"&&{borderRadius:"4px",paddingLeft:"7px",paddingRight:"7px",height:"24px"},...a.color==="primary"&&{border:`1px solid ${f.palette["color/primary/600"]}`,"& > .MuiTypography-root":{color:f.palette["color/primary/600"]},"&:hover":{border:`1px solid ${f.palette["color/primary/600"]}`,backgroundColor:f.palette["color/primary/dim/100"]},"& > .MuiButton-icon":{"& path, & circle":{fill:f.palette["color/primary/600"]},"& rect":{stroke:f.palette["color/primary/600"]}}},...(a.color==="default"||a.color==="gray")&&{border:`1px solid ${f.palette["color/gray/dim/400"]}`,"& > .MuiTypography-root":{color:f.palette["color/gray/800"]},"&:hover":{border:`1px solid ${f.palette["color/gray/dim/400"]}`,backgroundColor:f.palette["color/gray/dim/100"]}},"&.Mui-disabled":{"& > .MuiTypography-root":{color:f.palette["color/gray/200"]},border:`1px solid ${f.palette["color/gray/200"]}`,backgroundColor:f.palette["color/white"],"& > .MuiButton-icon":{"& path, & circle":{fill:f.palette["color/gray/200"]},"& rect":{stroke:f.palette["color/gray/200"]}}}}),text:({ownerState:a,theme:f})=>({borderRadius:"unset",padding:"unset",backgroundColor:"transparent",borderBottom:"1px solid transparent",...a.size==="XL"&&{height:"33px"},...a.size==="L"&&{height:"25px"},...a.size==="M"&&{height:"21px"},...a.size==="S"&&{height:"17px"},...a.color==="primary"&&{"& > .MuiTypography-root":{color:f.palette["color/primary/600"]},"&:hover":{borderBottom:`1px solid ${f.palette["color/primary/600"]}`,backgroundColor:"transparent"},"& > .MuiButton-icon":{"& path, & circle":{fill:f.palette["color/primary/600"]},"& rect":{stroke:f.palette["color/primary/600"]}}},...a.color==="default"&&{"& > .MuiTypography-root":{color:f.palette["color/gray/800"]},"&:hover":{borderBottom:`1px solid ${f.palette["color/gray/800"]}`,backgroundColor:"transparent"}},...a.color==="gray"&&{"& > .MuiTypography-root":{color:f.palette["color/gray/400"]},"&:hover":{borderBottom:`1px solid ${f.palette["color/gray/400"]}`,backgroundColor:"transparent"},"& > .MuiButton-icon":{"& path, & circle":{fill:f.palette["color/gray/400"]},"& rect":{stroke:f.palette["color/gray/400"]}}},"&.Mui-disabled":{"& > .MuiTypography-root":{color:f.palette["color/gray/200"]},"& > .MuiButton-icon":{"& path, & circle":{fill:f.palette["color/gray/200"]},"& rect":{stroke:f.palette["color/gray/200"]}}}})},variants:[{props:{variant:"underlined"},style:{margin:"4px",padding:" 0 0 2px 0",borderRadius:"unset",backgroundColor:"transparent"}},{props:a=>a.variant==="underlined"&&a.color==="primary",style:({theme:a})=>({borderBottom:`1px solid ${a.palette["color/primary/600"]}`,"& > .MuiTypography-root":{color:a.palette["color/primary/600"]},"& > .MuiButton-icon":{"& path, & circle":{fill:a.palette["color/primary/600"]},"& rect":{stroke:a.palette["color/primary/600"]}},"&:hover":{borderBottom:`1px solid ${a.palette["color/primary/700"]}`,backgroundColor:"transparent","& > .MuiTypography-root":{color:a.palette["color/primary/700"]},"& > .MuiButton-icon":{"& path, & circle":{fill:a.palette["color/primary/700"]},"& rect":{stroke:a.palette["color/primary/700"]}}}})},{props:a=>a.variant==="underlined"&&a.color==="default",style:({theme:a})=>({borderBottom:`1px solid ${a.palette["color/gray/800"]}`,"& > .MuiTypography-root":{color:a.palette["color/gray/800"]},"&:hover":{borderBottom:`1px solid ${a.palette["color/gray/600"]}`,backgroundColor:"transparent","& > .MuiTypography-root":{color:a.palette["color/gray/600"]},"& > .MuiButton-icon":{"& path, & circle":{fill:a.palette["color/gray/600"]},"& rect":{stroke:a.palette["color/gray/600"]}}}})},{props:a=>a.variant==="underlined"&&a.color==="gray",style:({theme:a})=>({borderBottom:`1px solid ${a.palette["color/gray/400"]}`,"& > .MuiTypography-root":{color:a.palette["color/gray/400"]},"& > .MuiButton-icon":{"& path, & circle":{fill:a.palette["color/gray/400"]},"& rect":{stroke:a.palette["color/gray/400"]}},"&:hover":{borderBottom:`1px solid ${a.palette["color/gray/600"]}`,backgroundColor:"transparent","& > .MuiTypography-root":{color:a.palette["color/gray/600"]},"& > .MuiButton-icon":{"& path, & circle":{fill:a.palette["color/gray/600"]},"& rect":{stroke:a.palette["color/gray/600"]}}}})},{props:a=>a.variant==="underlined"&&a.disabled,style:({theme:a})=>({borderBottom:`1px solid ${a.palette["color/gray/200"]}`,"& > .MuiTypography-root":{color:a.palette["color/gray/200"]},"& > .MuiButton-icon":{"& path, & circle":{fill:a.palette["color/gray/200"]},"& rect":{stroke:a.palette["color/gray/200"]}}})}]},MuiIconButton:{defaultProps:{disableRipple:!0},styleOverrides:{root:({ownerState:a,theme:f})=>({backgroundColor:"transparent",...a.size==="M"&&{width:"36px",height:"36px",padding:"6px",borderRadius:"8px","& > svg":{width:"24px",height:"24px"}},...a.size==="S"&&{width:"24px",height:"24px",padding:"4px",borderRadius:"4px","& > svg":{width:"16px",height:"16px"}},...a.color==="primary"&&{"&:hover":{backgroundColor:f.palette["color/primary/dim/100"]},"& path, & circle":{fill:f.palette["color/primary/600"]},"& rect":{stroke:f.palette["color/primary/600"]}},...a.color==="default"&&{"&:hover":{backgroundColor:f.palette["color/gray/100"]}},"&.Mui-disabled":{"& path, & circle":{fill:f.palette["color/gray/200"]},"& rect":{stroke:f.palette["color/gray/200"]}}})}}},typography:{...Ot,allVariants:{fontFamily:'"Pretendard Variable", Pretendard'}},spacing:4,breakpoints:{values:{mobile:0,desktop:768}},shadows:At});return Me(Jt,{theme:e,children:[q(Tt,{}),U]})}try{Oe.displayName="ThemeMui",Oe.__docgenInfo={description:"",displayName:"ThemeMui",props:{}}}catch{}export{Cc as A,kc as B,jt as C,za as D,ma as E,Af as G,Oe as T,X as _,$U as a,mt as b,fa as c,ba as d,Wt as e,na as f,Re as g,N as h,re as i,Ht as j,Ua as k,xf as l,_a as m,vf as n,sf as o,Of as p,It as q,Lt as r,ra as s,se as t,sa as u,fU as v,Cf as w,D as x,oa as y,_f as z};
