...
`),m.rippleVisible,tt,Z,({theme:e})=>e.transitions.easing.easeInOut,m.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,m.child,m.childLeaving,nt,Z,({theme:e})=>e.transitions.easing.easeInOut,m.childPulsate,ot,({theme:e})=>e.transitions.easing.easeInOut),st=a.forwardRef(function(r,s){const l=me({props:r,name:"MuiTouchRipple"}),{center:n=!1,classes:t={},className:o}=l,c=ee(l,Ze),[u,p]=a.useState([]),f=a.useRef(0),g=a.useRef(null);a.useEffect(()=>{g.current&&(g.current(),g.current=null)},[u]);const b=a.useRef(!1),x=je(),h=a.useRef(null),R=a.useRef(null),U=a.useCallback(d=>{const{pulsate:M,rippleX:y,rippleY:L,rippleSize:I,cb:j}=d;p(C=>[...C,_(rt,{classes:{ripple:E(t.ripple,m.ripple),rippleVisible:E(t.rippleVisible,m.rippleVisible),ripplePulsate:E(t.ripplePulsate,m.ripplePulsate),child:E(t.child,m.child),childLeaving:E(t.childLeaving,m.childLeaving),childPulsate:E(t.childPulsate,m.childPulsate)},timeout:Z,pulsate:M,rippleX:y,rippleY:L,rippleSize:I},f.current)]),f.current+=1,g.current=j},[t]),F=a.useCallback((d={},M={},y=()=>{})=>{const{pulsate:L=!1,center:I=n||M.pulsate,fakeElement:j=!1}=M;if((d==null?void 0:d.type)==="mousedown"&&b.current){b.current=!1;return}(d==null?void 0:d.type)==="touchstart"&&(b.current=!0);const C=j?null:R.current,P=C?C.getBoundingClientRect():{width:0,height:0,left:0,top:0};let V,S,D;if(I||d===void 0||d.clientX===0&&d.clientY===0||!d.clientX&&!d.touches)V=Math.round(P.width/2),S=Math.round(P.height/2);else{const{clientX:$,clientY:v}=d.touches&&d.touches.length>0?d.touches[0]:d;V=Math.round($-P.left),S=Math.round(v-P.top)}if(I)D=Math.sqrt((2*P.width**2+P.height**2)/3),D%2===0&&(D+=1);else{const $=Math.max(Math.abs((C?C.clientWidth:0)-V),V)*2+2,v=Math.max(Math.abs((C?C.clientHeight:0)-S),S)*2+2;D=Math.sqrt($**2+v**2)}d!=null&&d.touches?h.current===null&&(h.current=()=>{U({pulsate:L,rippleX:V,rippleY:S,rippleSize:D,cb:y})},x.start(et,()=>{h.current&&(h.current(),h.current=null)})):U({pulsate:L,rippleX:V,rippleY:S,rippleSize:D,cb:y})},[n,U,x]),z=a.useCallback(()=>{F({},{pulsate:!0})},[F]),N=a.useCallback((d,M)=>{if(x.clear(),(d==null?void 0:d.type)==="touchend"&&h.current){h.current(),h.current=null,x.start(0,()=>{N(d,M)});return}h.current=null,p(y=>y.length>0?y.slice(1):y),g.current=M},[x]);return a.useImperativeHandle(s,()=>({pulsate:z,start:F,stop:N}),[z,F,N]),_(it,X({className:E(m.root,t.root,o),ref:R},c,{children:_(qe,{component:null,exit:!0,children:u})}))}),at=st;function lt(e){return _e("MuiButtonBase",e)}const ut=be("MuiButtonBase",["root","disabled","focusVisible"]),ct=ut,pt=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],dt=e=>{const{disabled:r,focusVisible:s,focusVisibleClassName:l,classes:n}=e,o=Ue({root:["root",r&&"disabled",s&&"focusVisible"]},lt,n);return s&&l&&(o.root+=` ${l}`),o},ft=ne("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,r)=>r.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${ct.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),ht=a.forwardRef(function(r,s){const l=me({props:r,name:"MuiButtonBase"}),{action:n,centerRipple:t=!1,children:o,className:c,component:u="button",disabled:p=!1,disableRipple:f=!1,disableTouchRipple:g=!1,focusRipple:b=!1,LinkComponent:x="a",onBlur:h,onClick:R,onContextMenu:U,onDragLeave:F,onFocus:z,onFocusVisible:N,onKeyDown:d,onKeyUp:M,onMouseDown:y,onMouseLeave:L,onMouseUp:I,onTouchEnd:j,onTouchMove:C,onTouchStart:P,tabIndex:V=0,TouchRippleProps:S,touchRippleRef:D,type:$}=l,v=ee(l,pt),O=a.useRef(null),T=a.useRef(null),ge=ce(T,D),{isFocusVisibleRef:re,onFocus:Re,onBlur:Me,ref:ye}=Oe(),[k,Y]=a.useState(!1);p&&k&&Y(!1),a.useImperativeHandle(n,()=>({focusVisible:()=>{Y(!0),O.current.focus()}}),[]);const[q,Ce]=a.useState(!1);a.useEffect(()=>{Ce(!0)},[]);const Te=q&&!f&&!p;a.useEffect(()=>{k&&b&&!f&&q&&T.current.pulsate()},[f,b,k,q]);function B(i,ae,Ie=g){return H(le=>(ae&&ae(le),!Ie&&T.current&&T.current[i](le),!0))}const Ee=B("start",y),xe=B("stop",U),Ve=B("stop",F),ve=B("stop",I),Be=B("stop",i=>{k&&i.preventDefault(),L&&L(i)}),Pe=B("start",P),Se=B("stop",j),De=B("stop",C),Le=B("stop",i=>{Me(i),re.current===!1&&Y(!1),h&&h(i)},!1),$e=H(i=>{O.current||(O.current=i.currentTarget),Re(i),re.current===!0&&(Y(!0),N&&N(i)),z&&z(i)}),J=()=>{const i=O.current;return u&&u!=="button"&&!(i.tagName==="A"&&i.href)},Q=a.useRef(!1),ke=H(i=>{b&&!Q.current&&k&&T.current&&i.key===" "&&(Q.current=!0,T.current.stop(i,()=>{T.current.start(i)})),i.target===i.currentTarget&&J()&&i.key===" "&&i.preventDefault(),d&&d(i),i.target===i.currentTarget&&J()&&i.key==="Enter"&&!p&&(i.preventDefault(),R&&R(i))}),we=H(i=>{b&&i.key===" "&&T.current&&k&&!i.defaultPrevented&&(Q.current=!1,T.current.stop(i,()=>{T.current.pulsate(i)})),M&&M(i),R&&i.target===i.currentTarget&&J()&&i.key===" "&&!i.defaultPrevented&&R(i)});let A=u;A==="button"&&(v.href||v.to)&&(A=x);const K={};A==="button"?(K.type=$===void 0?"button":$,K.disabled=p):(!v.href&&!v.to&&(K.role="button"),p&&(K["aria-disabled"]=p));const Fe=ce(s,ye,O),se=X({},l,{centerRipple:t,component:u,disabled:p,disableRipple:f,disableTouchRipple:g,focusRipple:b,tabIndex:V,focusVisible:k}),Ne=dt(se);return ze(ft,X({as:A,className:E(Ne.root,c),ownerState:se,onBlur:Le,onClick:R,onContextMenu:xe,onFocus:$e,onKeyDown:ke,onKeyUp:we,onMouseDown:Ee,onMouseLeave:Be,onMouseUp:ve,onDragLeave:Ve,onTouchEnd:Se,onTouchMove:De,onTouchStart:Pe,ref:Fe,tabIndex:p?-1:V,type:$},K,v,{children:[o,Te?_(at,X({ref:ge,center:t},S)):null]}))}),vt=ht;export{vt as B};
