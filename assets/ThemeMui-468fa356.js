import{j as N,a as Be,u as wa}from"./Color-443384d2.js";import{_ as g,a as ue}from"./extends-623938b0.js";import{a as Ee,g as Pa}from"./_commonjsHelpers-de833af9.js";import{r as W}from"./index-76fb7be0.js";function X(U,e){if(U==null)return{};var a={},f=Object.keys(U),c,t;for(t=0;t<f.length;t++)c=f[t],!(e.indexOf(c)>=0)&&(a[c]=U[c]);return a}function We(U,e){const a=g({},e);return Object.keys(U).forEach(f=>{if(f.toString().match(/^(components|slots)$/))a[f]=g({},U[f],a[f]);else if(f.toString().match(/^(componentsProps|slotProps)$/)){const c=U[f]||{},t=e[f];a[f]={},!t||!Object.keys(t)?a[f]=c:!c||!Object.keys(c)?a[f]=t:(a[f]=g({},t),Object.keys(c).forEach(d=>{a[f][d]=We(c[d],t[d])}))}else a[f]===void 0&&(a[f]=U[f])}),a}var $={},He={exports:{}};(function(U){function e(a){return a&&a.__esModule?a:{default:a}}U.exports=e,U.exports.__esModule=!0,U.exports.default=U.exports})(He);var va=He.exports;function sU(U){let e="https://mui.com/production-error/?code="+U;for(let a=1;a<arguments.length;a+=1)e+="&args[]="+encodeURIComponent(arguments[a]);return"Minified MUI error #"+U+"; visit "+e+" for the full message."}const xa=Object.freeze(Object.defineProperty({__proto__:null,default:sU},Symbol.toStringTag,{value:"Module"})),Va=Ee(xa);function Ja(U,e=Number.MIN_SAFE_INTEGER,a=Number.MAX_SAFE_INTEGER){return Math.max(e,Math.min(U,a))}const Sa=Object.freeze(Object.defineProperty({__proto__:null,default:Ja},Symbol.toStringTag,{value:"Module"})),$a=Ee(Sa);var je=va;Object.defineProperty($,"__esModule",{value:!0});var Nt=$.alpha=Fe;$.blend=Ha;$.colorChannel=void 0;var ka=$.darken=QU;$.decomposeColor=H;$.emphasize=Wa;var Ca=$.getContrastRatio=_a;$.getLuminance=VU;$.hexToRgb=Ie;$.hslToRgb=Ke;var Ta=$.lighten=Ue;$.private_safeAlpha=za;$.private_safeColorChannel=void 0;$.private_safeDarken=Ba;$.private_safeEmphasize=De;$.private_safeLighten=Ea;$.recomposeColor=rU;$.rgbToHex=Ra;var me=je(Va),Oa=je($a);function ZU(U,e=0,a=1){return(0,Oa.default)(U,e,a)}function Ie(U){U=U.slice(1);const e=new RegExp(`.{1,${U.length>=6?2:1}}`,"g");let a=U.match(e);return a&&a[0].length===1&&(a=a.map(f=>f+f)),a?`rgb${a.length===4?"a":""}(${a.map((f,c)=>c<3?parseInt(f,16):Math.round(parseInt(f,16)/255*1e3)/1e3).join(", ")})`:""}function Ma(U){const e=U.toString(16);return e.length===1?`0${e}`:e}function H(U){if(U.type)return U;if(U.charAt(0)==="#")return H(Ie(U));const e=U.indexOf("("),a=U.substring(0,e);if(["rgb","rgba","hsl","hsla","color"].indexOf(a)===-1)throw new Error((0,me.default)(9,U));let f=U.substring(e+1,U.length-1),c;if(a==="color"){if(f=f.split(" "),c=f.shift(),f.length===4&&f[3].charAt(0)==="/"&&(f[3]=f[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(c)===-1)throw new Error((0,me.default)(10,c))}else f=f.split(",");return f=f.map(t=>parseFloat(t)),{type:a,values:f,colorSpace:c}}const Le=U=>{const e=H(U);return e.values.slice(0,3).map((a,f)=>e.type.indexOf("hsl")!==-1&&f!==0?`${a}%`:a).join(" ")};$.colorChannel=Le;const Aa=(U,e)=>{try{return Le(U)}catch{return U}};$.private_safeColorChannel=Aa;function rU(U){const{type:e,colorSpace:a}=U;let{values:f}=U;return e.indexOf("rgb")!==-1?f=f.map((c,t)=>t<3?parseInt(c,10):c):e.indexOf("hsl")!==-1&&(f[1]=`${f[1]}%`,f[2]=`${f[2]}%`),e.indexOf("color")!==-1?f=`${a} ${f.join(" ")}`:f=`${f.join(", ")}`,`${e}(${f})`}function Ra(U){if(U.indexOf("#")===0)return U;const{values:e}=H(U);return`#${e.map((a,f)=>Ma(f===3?Math.round(255*a):a)).join("")}`}function Ke(U){U=H(U);const{values:e}=U,a=e[0],f=e[1]/100,c=e[2]/100,t=f*Math.min(c,1-c),d=(b,l=(b+a/30)%12)=>c-t*Math.max(Math.min(l-3,9-l,1),-1);let r="rgb";const n=[Math.round(d(0)*255),Math.round(d(8)*255),Math.round(d(4)*255)];return U.type==="hsla"&&(r+="a",n.push(e[3])),rU({type:r,values:n})}function VU(U){U=H(U);let e=U.type==="hsl"||U.type==="hsla"?H(Ke(U)).values:U.values;return e=e.map(a=>(U.type!=="color"&&(a/=255),a<=.03928?a/12.92:((a+.055)/1.055)**2.4)),Number((.2126*e[0]+.7152*e[1]+.0722*e[2]).toFixed(3))}function _a(U,e){const a=VU(U),f=VU(e);return(Math.max(a,f)+.05)/(Math.min(a,f)+.05)}function Fe(U,e){return U=H(U),e=ZU(e),(U.type==="rgb"||U.type==="hsl")&&(U.type+="a"),U.type==="color"?U.values[3]=`/${e}`:U.values[3]=e,rU(U)}function za(U,e,a){try{return Fe(U,e)}catch{return U}}function QU(U,e){if(U=H(U),e=ZU(e),U.type.indexOf("hsl")!==-1)U.values[2]*=1-e;else if(U.type.indexOf("rgb")!==-1||U.type.indexOf("color")!==-1)for(let a=0;a<3;a+=1)U.values[a]*=1-e;return rU(U)}function Ba(U,e,a){try{return QU(U,e)}catch{return U}}function Ue(U,e){if(U=H(U),e=ZU(e),U.type.indexOf("hsl")!==-1)U.values[2]+=(100-U.values[2])*e;else if(U.type.indexOf("rgb")!==-1)for(let a=0;a<3;a+=1)U.values[a]+=(255-U.values[a])*e;else if(U.type.indexOf("color")!==-1)for(let a=0;a<3;a+=1)U.values[a]+=(1-U.values[a])*e;return rU(U)}function Ea(U,e,a){try{return Ue(U,e)}catch{return U}}function Wa(U,e=.15){return VU(U)>.5?QU(U,e):Ue(U,e)}function De(U,e,a){try{return De(U,e)}catch{return U}}function Ha(U,e,a,f=1){const c=(n,b)=>Math.round((n**(1/f)*(1-a)+b**(1/f)*a)**f),t=H(U),d=H(e),r=[c(t.values[0],d.values[0]),c(t.values[1],d.values[1]),c(t.values[2],d.values[2])];return rU({type:"rgb",values:r})}var GU={exports:{}},ge;function ja(){return ge||(ge=1,function(U){function e(){return U.exports=e=Object.assign?Object.assign.bind():function(a){for(var f=1;f<arguments.length;f++){var c=arguments[f];for(var t in c)Object.prototype.hasOwnProperty.call(c,t)&&(a[t]=c[t])}return a},U.exports.__esModule=!0,U.exports.default=U.exports,e.apply(this,arguments)}U.exports=e,U.exports.__esModule=!0,U.exports.default=U.exports}(GU)),GU.exports}function Ia(U){var e=Object.create(null);return function(a){return e[a]===void 0&&(e[a]=U(a)),e[a]}}function La(U){if(U.sheet)return U.sheet;for(var e=0;e<document.styleSheets.length;e++)if(document.styleSheets[e].ownerNode===U)return document.styleSheets[e]}function Ka(U){var e=document.createElement("style");return e.setAttribute("data-emotion",U.key),U.nonce!==void 0&&e.setAttribute("nonce",U.nonce),e.appendChild(document.createTextNode("")),e.setAttribute("data-s",""),e}var Fa=function(){function U(a){var f=this;this._insertTag=function(c){var t;f.tags.length===0?f.insertionPoint?t=f.insertionPoint.nextSibling:f.prepend?t=f.container.firstChild:t=f.before:t=f.tags[f.tags.length-1].nextSibling,f.container.insertBefore(c,t),f.tags.push(c)},this.isSpeedy=a.speedy===void 0?!0:a.speedy,this.tags=[],this.ctr=0,this.nonce=a.nonce,this.key=a.key,this.container=a.container,this.prepend=a.prepend,this.insertionPoint=a.insertionPoint,this.before=null}var e=U.prototype;return e.hydrate=function(f){f.forEach(this._insertTag)},e.insert=function(f){this.ctr%(this.isSpeedy?65e3:1)===0&&this._insertTag(Ka(this));var c=this.tags[this.tags.length-1];if(this.isSpeedy){var t=La(c);try{t.insertRule(f,t.cssRules.length)}catch{}}else c.appendChild(document.createTextNode(f));this.ctr++},e.flush=function(){this.tags.forEach(function(f){return f.parentNode&&f.parentNode.removeChild(f)}),this.tags=[],this.ctr=0},U}(),M="-ms-",JU="-moz-",u="-webkit-",Ge="comm",ee="rule",ae="decl",Da="@import",Ne="@keyframes",Ga="@layer",Na=Math.abs,kU=String.fromCharCode,qa=Object.assign;function Xa(U,e){return O(U,0)^45?(((e<<2^O(U,0))<<2^O(U,1))<<2^O(U,2))<<2^O(U,3):0}function qe(U){return U.trim()}function Ya(U,e){return(U=e.exec(U))?U[0]:U}function m(U,e,a){return U.replace(e,a)}function XU(U,e){return U.indexOf(e)}function O(U,e){return U.charCodeAt(e)|0}function lU(U,e,a){return U.slice(e,a)}function L(U){return U.length}function fe(U){return U.length}function wU(U,e){return e.push(U),U}function Za(U,e){return U.map(e).join("")}var CU=1,dU=1,Xe=0,R=0,C=0,nU="";function TU(U,e,a,f,c,t,d){return{value:U,root:e,parent:a,type:f,props:c,children:t,line:CU,column:dU,length:d,return:""}}function oU(U,e){return qa(TU("",null,null,"",null,null,0),U,{length:-U.length},e)}function Qa(){return C}function Uf(){return C=R>0?O(nU,--R):0,dU--,C===10&&(dU=1,CU--),C}function z(){return C=R<Xe?O(nU,R++):0,dU++,C===10&&(dU=1,CU++),C}function F(){return O(nU,R)}function PU(){return R}function gU(U,e){return lU(nU,U,e)}function pU(U){switch(U){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function Ye(U){return CU=dU=1,Xe=L(nU=U),R=0,[]}function Ze(U){return nU="",U}function vU(U){return qe(gU(R-1,YU(U===91?U+2:U===40?U+1:U)))}function ef(U){for(;(C=F())&&C<33;)z();return pU(U)>2||pU(C)>3?"":" "}function af(U,e){for(;--e&&z()&&!(C<48||C>102||C>57&&C<65||C>70&&C<97););return gU(U,PU()+(e<6&&F()==32&&z()==32))}function YU(U){for(;z();)switch(C){case U:return R;case 34:case 39:U!==34&&U!==39&&YU(C);break;case 40:U===41&&YU(U);break;case 92:z();break}return R}function ff(U,e){for(;z()&&U+C!==47+10;)if(U+C===42+42&&F()===47)break;return"/*"+gU(e,R-1)+"*"+kU(U===47?U:z())}function cf(U){for(;!pU(F());)z();return gU(U,R)}function tf(U){return Ze(xU("",null,null,null,[""],U=Ye(U),0,[0],U))}function xU(U,e,a,f,c,t,d,r,n){for(var b=0,l=0,s=d,i=0,y=0,p=0,o=1,v=1,w=1,S=0,A="",Y=c,D=t,I=f,P=A;v;)switch(p=S,S=z()){case 40:if(p!=108&&O(P,s-1)==58){XU(P+=m(vU(S),"&","&\f"),"&\f")!=-1&&(w=-1);break}case 34:case 39:case 91:P+=vU(S);break;case 9:case 10:case 13:case 32:P+=ef(p);break;case 92:P+=af(PU()-1,7);continue;case 47:switch(F()){case 42:case 47:wU(df(ff(z(),PU()),e,a),n);break;default:P+="/"}break;case 123*o:r[b++]=L(P)*w;case 125*o:case 59:case 0:switch(S){case 0:case 125:v=0;case 59+l:w==-1&&(P=m(P,/\f/g,"")),y>0&&L(P)-s&&wU(y>32?he(P+";",f,a,s-1):he(m(P," ","")+";",f,a,s-2),n);break;case 59:P+=";";default:if(wU(I=ye(P,e,a,b,l,c,r,A,Y=[],D=[],s),t),S===123)if(l===0)xU(P,e,I,I,Y,t,s,r,D);else switch(i===99&&O(P,3)===110?100:i){case 100:case 108:case 109:case 115:xU(U,I,I,f&&wU(ye(U,I,I,0,0,c,r,A,c,Y=[],s),D),c,D,s,r,f?Y:D);break;default:xU(P,I,I,I,[""],D,0,r,D)}}b=l=y=0,o=w=1,A=P="",s=d;break;case 58:s=1+L(P),y=p;default:if(o<1){if(S==123)--o;else if(S==125&&o++==0&&Uf()==125)continue}switch(P+=kU(S),S*o){case 38:w=l>0?1:(P+="\f",-1);break;case 44:r[b++]=(L(P)-1)*w,w=1;break;case 64:F()===45&&(P+=vU(z())),i=F(),l=s=L(A=P+=cf(PU())),S++;break;case 45:p===45&&L(P)==2&&(o=0)}}return t}function ye(U,e,a,f,c,t,d,r,n,b,l){for(var s=c-1,i=c===0?t:[""],y=fe(i),p=0,o=0,v=0;p<f;++p)for(var w=0,S=lU(U,s+1,s=Na(o=d[p])),A=U;w<y;++w)(A=qe(o>0?i[w]+" "+S:m(S,/&\f/g,i[w])))&&(n[v++]=A);return TU(U,e,a,c===0?ee:r,n,b,l)}function df(U,e,a){return TU(U,e,a,Ge,kU(Qa()),lU(U,2,-2),0)}function he(U,e,a,f){return TU(U,e,a,ae,lU(U,0,f),lU(U,f+1,-1),f)}function cU(U,e){for(var a="",f=fe(U),c=0;c<f;c++)a+=e(U[c],c,U,e)||"";return a}function rf(U,e,a,f){switch(U.type){case Ga:if(U.children.length)break;case Da:case ae:return U.return=U.return||U.value;case Ge:return"";case Ne:return U.return=U.value+"{"+cU(U.children,f)+"}";case ee:U.value=U.props.join(",")}return L(a=cU(U.children,f))?U.return=U.value+"{"+a+"}":""}function nf(U){var e=fe(U);return function(a,f,c,t){for(var d="",r=0;r<e;r++)d+=U[r](a,f,c,t)||"";return d}}function of(U){return function(e){e.root||(e=e.return)&&U(e)}}var bf=function(e,a,f){for(var c=0,t=0;c=t,t=F(),c===38&&t===12&&(a[f]=1),!pU(t);)z();return gU(e,R)},sf=function(e,a){var f=-1,c=44;do switch(pU(c)){case 0:c===38&&F()===12&&(a[f]=1),e[f]+=bf(R-1,a,f);break;case 2:e[f]+=vU(c);break;case 4:if(c===44){e[++f]=F()===58?"&\f":"",a[f]=e[f].length;break}default:e[f]+=kU(c)}while(c=z());return e},lf=function(e,a){return Ze(sf(Ye(e),a))},we=new WeakMap,pf=function(e){if(!(e.type!=="rule"||!e.parent||e.length<1)){for(var a=e.value,f=e.parent,c=e.column===f.column&&e.line===f.line;f.type!=="rule";)if(f=f.parent,!f)return;if(!(e.props.length===1&&a.charCodeAt(0)!==58&&!we.get(f))&&!c){we.set(e,!0);for(var t=[],d=lf(a,t),r=f.props,n=0,b=0;n<d.length;n++)for(var l=0;l<r.length;l++,b++)e.props[b]=t[n]?d[n].replace(/&\f/g,r[l]):r[l]+" "+d[n]}}},uf=function(e){if(e.type==="decl"){var a=e.value;a.charCodeAt(0)===108&&a.charCodeAt(2)===98&&(e.return="",e.value="")}};function Qe(U,e){switch(Xa(U,e)){case 5103:return u+"print-"+U+U;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return u+U+U;case 5349:case 4246:case 4810:case 6968:case 2756:return u+U+JU+U+M+U+U;case 6828:case 4268:return u+U+M+U+U;case 6165:return u+U+M+"flex-"+U+U;case 5187:return u+U+m(U,/(\w+).+(:[^]+)/,u+"box-$1$2"+M+"flex-$1$2")+U;case 5443:return u+U+M+"flex-item-"+m(U,/flex-|-self/,"")+U;case 4675:return u+U+M+"flex-line-pack"+m(U,/align-content|flex-|-self/,"")+U;case 5548:return u+U+M+m(U,"shrink","negative")+U;case 5292:return u+U+M+m(U,"basis","preferred-size")+U;case 6060:return u+"box-"+m(U,"-grow","")+u+U+M+m(U,"grow","positive")+U;case 4554:return u+m(U,/([^-])(transform)/g,"$1"+u+"$2")+U;case 6187:return m(m(m(U,/(zoom-|grab)/,u+"$1"),/(image-set)/,u+"$1"),U,"")+U;case 5495:case 3959:return m(U,/(image-set\([^]*)/,u+"$1$`$1");case 4968:return m(m(U,/(.+:)(flex-)?(.*)/,u+"box-pack:$3"+M+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+u+U+U;case 4095:case 3583:case 4068:case 2532:return m(U,/(.+)-inline(.+)/,u+"$1$2")+U;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(L(U)-1-e>6)switch(O(U,e+1)){case 109:if(O(U,e+4)!==45)break;case 102:return m(U,/(.+:)(.+)-([^]+)/,"$1"+u+"$2-$3$1"+JU+(O(U,e+3)==108?"$3":"$2-$3"))+U;case 115:return~XU(U,"stretch")?Qe(m(U,"stretch","fill-available"),e)+U:U}break;case 4949:if(O(U,e+1)!==115)break;case 6444:switch(O(U,L(U)-3-(~XU(U,"!important")&&10))){case 107:return m(U,":",":"+u)+U;case 101:return m(U,/(.+:)([^;!]+)(;|!.+)?/,"$1"+u+(O(U,14)===45?"inline-":"")+"box$3$1"+u+"$2$3$1"+M+"$2box$3")+U}break;case 5936:switch(O(U,e+11)){case 114:return u+U+M+m(U,/[svh]\w+-[tblr]{2}/,"tb")+U;case 108:return u+U+M+m(U,/[svh]\w+-[tblr]{2}/,"tb-rl")+U;case 45:return u+U+M+m(U,/[svh]\w+-[tblr]{2}/,"lr")+U}return u+U+M+U+U}return U}var mf=function(e,a,f,c){if(e.length>-1&&!e.return)switch(e.type){case ae:e.return=Qe(e.value,e.length);break;case Ne:return cU([oU(e,{value:m(e.value,"@","@"+u)})],c);case ee:if(e.length)return Za(e.props,function(t){switch(Ya(t,/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":return cU([oU(e,{props:[m(t,/:(read-\w+)/,":"+JU+"$1")]})],c);case"::placeholder":return cU([oU(e,{props:[m(t,/:(plac\w+)/,":"+u+"input-$1")]}),oU(e,{props:[m(t,/:(plac\w+)/,":"+JU+"$1")]}),oU(e,{props:[m(t,/:(plac\w+)/,M+"input-$1")]})],c)}return""})}},gf=[mf],yf=function(e){var a=e.key;if(a==="css"){var f=document.querySelectorAll("style[data-emotion]:not([data-s])");Array.prototype.forEach.call(f,function(o){var v=o.getAttribute("data-emotion");v.indexOf(" ")!==-1&&(document.head.appendChild(o),o.setAttribute("data-s",""))})}var c=e.stylisPlugins||gf,t={},d,r=[];d=e.container||document.head,Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="'+a+' "]'),function(o){for(var v=o.getAttribute("data-emotion").split(" "),w=1;w<v.length;w++)t[v[w]]=!0;r.push(o)});var n,b=[pf,uf];{var l,s=[rf,of(function(o){l.insert(o)})],i=nf(b.concat(c,s)),y=function(v){return cU(tf(v),i)};n=function(v,w,S,A){l=S,y(v?v+"{"+w.styles+"}":w.styles),A&&(p.inserted[w.name]=!0)}}var p={key:a,sheet:new Fa({key:a,container:d,nonce:e.nonce,speedy:e.speedy,prepend:e.prepend,insertionPoint:e.insertionPoint}),nonce:e.nonce,inserted:t,registered:{},insert:n};return p.sheet.hydrate(r),p},Ua={exports:{}},h={};/** @license React v16.13.1
 ...
 */var T=typeof Symbol=="function"&&Symbol.for,ce=T?Symbol.for("react.element"):60103,te=T?Symbol.for("react.portal"):60106,OU=T?Symbol.for("react.fragment"):60107,MU=T?Symbol.for("react.strict_mode"):60108,AU=T?Symbol.for("react.profiler"):60114,RU=T?Symbol.for("react.provider"):60109,_U=T?Symbol.for("react.context"):60110,de=T?Symbol.for("react.async_mode"):60111,zU=T?Symbol.for("react.concurrent_mode"):60111,BU=T?Symbol.for("react.forward_ref"):60112,EU=T?Symbol.for("react.suspense"):60113,hf=T?Symbol.for("react.suspense_list"):60120,WU=T?Symbol.for("react.memo"):60115,HU=T?Symbol.for("react.lazy"):60116,wf=T?Symbol.for("react.block"):60121,Pf=T?Symbol.for("react.fundamental"):60117,vf=T?Symbol.for("react.responder"):60118,xf=T?Symbol.for("react.scope"):60119;function B(U){if(typeof U=="object"&&U!==null){var e=U.$$typeof;switch(e){case ce:switch(U=U.type,U){case de:case zU:case OU:case AU:case MU:case EU:return U;default:switch(U=U&&U.$$typeof,U){case _U:case BU:case HU:case WU:case RU:return U;default:return e}}case te:return e}}}function ea(U){return B(U)===zU}h.AsyncMode=de;h.ConcurrentMode=zU;h.ContextConsumer=_U;h.ContextProvider=RU;h.Element=ce;h.ForwardRef=BU;h.Fragment=OU;h.Lazy=HU;h.Memo=WU;h.Portal=te;h.Profiler=AU;h.StrictMode=MU;h.Suspense=EU;h.isAsyncMode=function(U){return ea(U)||B(U)===de};h.isConcurrentMode=ea;h.isContextConsumer=function(U){return B(U)===_U};h.isContextProvider=function(U){return B(U)===RU};h.isElement=function(U){return typeof U=="object"&&U!==null&&U.$$typeof===ce};h.isForwardRef=function(U){return B(U)===BU};h.isFragment=function(U){return B(U)===OU};h.isLazy=function(U){return B(U)===HU};h.isMemo=function(U){return B(U)===WU};h.isPortal=function(U){return B(U)===te};h.isProfiler=function(U){return B(U)===AU};h.isStrictMode=function(U){return B(U)===MU};h.isSuspense=function(U){return B(U)===EU};h.isValidElementType=function(U){return typeof U=="string"||typeof U=="function"||U===OU||U===zU||U===AU||U===MU||U===EU||U===hf||typeof U=="object"&&U!==null&&(U.$$typeof===HU||U.$$typeof===WU||U.$$typeof===RU||U.$$typeof===_U||U.$$typeof===BU||U.$$typeof===Pf||U.$$typeof===vf||U.$$typeof===xf||U.$$typeof===wf)};h.typeOf=B;Ua.exports=h;var Vf=Ua.exports,re=Vf,Jf={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},Sf={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},$f={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},aa={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},ne={};ne[re.ForwardRef]=$f;ne[re.Memo]=aa;function Pe(U){return re.isMemo(U)?aa:ne[U.$$typeof]||Jf}var kf=Object.defineProperty,Cf=Object.getOwnPropertyNames,ve=Object.getOwnPropertySymbols,Tf=Object.getOwnPropertyDescriptor,Of=Object.getPrototypeOf,xe=Object.prototype;function fa(U,e,a){if(typeof e!="string"){if(xe){var f=Of(e);f&&f!==xe&&fa(U,f,a)}var c=Cf(e);ve&&(c=c.concat(ve(e)));for(var t=Pe(U),d=Pe(e),r=0;r<c.length;++r){var n=c[r];if(!Sf[n]&&!(a&&a[n])&&!(d&&d[n])&&!(t&&t[n])){var b=Tf(e,n);try{kf(U,n,b)}catch{}}}}return U}var Mf=fa;const qt=Pa(Mf);var Af=!0;function Xt(U,e,a){var f="";return a.split(" ").forEach(function(c){U[c]!==void 0?e.push(U[c]+";"):f+=c+" "}),f}var Rf=function(e,a,f){var c=e.key+"-"+a.name;(f===!1||Af===!1)&&e.registered[c]===void 0&&(e.registered[c]=a.styles)},_f=function(e,a,f){Rf(e,a,f);var c=e.key+"-"+a.name;if(e.inserted[a.name]===void 0){var t=a;do e.insert(a===t?"."+c:"",t,e.sheet,!0),t=t.next;while(t!==void 0)}};function zf(U){for(var e=0,a,f=0,c=U.length;c>=4;++f,c-=4)a=U.charCodeAt(f)&255|(U.charCodeAt(++f)&255)<<8|(U.charCodeAt(++f)&255)<<16|(U.charCodeAt(++f)&255)<<24,a=(a&65535)*1540483477+((a>>>16)*59797<<16),a^=a>>>24,e=(a&65535)*1540483477+((a>>>16)*59797<<16)^(e&65535)*1540483477+((e>>>16)*59797<<16);switch(c){case 3:e^=(U.charCodeAt(f+2)&255)<<16;case 2:e^=(U.charCodeAt(f+1)&255)<<8;case 1:e^=U.charCodeAt(f)&255,e=(e&65535)*1540483477+((e>>>16)*59797<<16)}return e^=e>>>13,e=(e&65535)*1540483477+((e>>>16)*59797<<16),((e^e>>>15)>>>0).toString(36)}var Bf={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},Ef=/[A-Z]|^ms/g,Wf=/_EMO_([^_]+?)_([^]*?)_EMO_/g,ca=function(e){return e.charCodeAt(1)===45},Ve=function(e){return e!=null&&typeof e!="boolean"},NU=Ia(function(U){return ca(U)?U:U.replace(Ef,"-$&").toLowerCase()}),Je=function(e,a){switch(e){case"animation":case"animationName":if(typeof a=="string")return a.replace(Wf,function(f,c,t){return K={name:c,styles:t,next:K},c})}return Bf[e]!==1&&!ca(e)&&typeof a=="number"&&a!==0?a+"px":a};function uU(U,e,a){if(a==null)return"";if(a.__emotion_styles!==void 0)return a;switch(typeof a){case"boolean":return"";case"object":{if(a.anim===1)return K={name:a.name,styles:a.styles,next:K},a.name;if(a.styles!==void 0){var f=a.next;if(f!==void 0)for(;f!==void 0;)K={name:f.name,styles:f.styles,next:K},f=f.next;var c=a.styles+";";return c}return Hf(U,e,a)}case"function":{if(U!==void 0){var t=K,d=a(U);return K=t,uU(U,e,d)}break}}if(e==null)return a;var r=e[a];return r!==void 0?r:a}function Hf(U,e,a){var f="";if(Array.isArray(a))for(var c=0;c<a.length;c++)f+=uU(U,e,a[c])+";";else for(var t in a){var d=a[t];if(typeof d!="object")e!=null&&e[d]!==void 0?f+=t+"{"+e[d]+"}":Ve(d)&&(f+=NU(t)+":"+Je(t,d)+";");else if(Array.isArray(d)&&typeof d[0]=="string"&&(e==null||e[d[0]]===void 0))for(var r=0;r<d.length;r++)Ve(d[r])&&(f+=NU(t)+":"+Je(t,d[r])+";");else{var n=uU(U,e,d);switch(t){case"animation":case"animationName":{f+=NU(t)+":"+n+";";break}default:f+=t+"{"+n+"}"}}}return f}var Se=/label:\s*([^\s;\n{]+)\s*(;|$)/g,K,ta=function(e,a,f){if(e.length===1&&typeof e[0]=="object"&&e[0]!==null&&e[0].styles!==void 0)return e[0];var c=!0,t="";K=void 0;var d=e[0];d==null||d.raw===void 0?(c=!1,t+=uU(f,a,d)):t+=d[0];for(var r=1;r<e.length;r++)t+=uU(f,a,e[r]),c&&(t+=d[r]);Se.lastIndex=0;for(var n="",b;(b=Se.exec(t))!==null;)n+="-"+b[1];var l=zf(t)+n;return{name:l,styles:t,next:K}},da=W.createContext(typeof HTMLElement<"u"?yf({key:"css"}):null),Yt=da.Provider,jf=function(e){return W.forwardRef(function(a,f){var c=W.useContext(da);return e(a,c,f)})},oe=W.createContext({});ja();var If=jf(function(U,e){var a=U.styles,f=ta([a],void 0,W.useContext(oe)),c=W.useRef();return ue(function(){var t=e.key+"-global",d=new e.sheet.constructor({key:t,nonce:e.sheet.nonce,container:e.sheet.container,speedy:e.sheet.isSpeedy}),r=!1,n=document.querySelector('style[data-emotion="'+t+" "+f.name+'"]');return e.sheet.tags.length&&(d.before=e.sheet.tags[0]),n!==null&&(r=!0,n.setAttribute("data-emotion",t),d.hydrate([n])),c.current=[d,r],function(){d.flush()}},[e]),ue(function(){var t=c.current,d=t[0],r=t[1];if(r){t[1]=!1;return}if(f.next!==void 0&&_f(e,f.next,!0),d.tags.length){var n=d.tags[d.tags.length-1].nextElementSibling;d.before=n,d.flush()}e.insert("",f,d,!1)},[e,f.name]),null});function Lf(){for(var U=arguments.length,e=new Array(U),a=0;a<U;a++)e[a]=arguments[a];return ta(e)}var Zt=function(){var e=Lf.apply(void 0,arguments),a="animation-"+e.name;return{name:a,styles:"@keyframes "+a+"{"+e.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}};function Kf(U){return U==null||Object.keys(U).length===0}function Ff(U){const{styles:e,defaultTheme:a={}}=U;return N(If,{styles:typeof e=="function"?c=>e(Kf(c)?a:c):e})}function fU(U){if(typeof U!="object"||U===null)return!1;const e=Object.getPrototypeOf(U);return(e===null||e===Object.prototype||Object.getPrototypeOf(e)===null)&&!(Symbol.toStringTag in U)&&!(Symbol.iterator in U)}function ra(U){if(!fU(U))return U;const e={};return Object.keys(U).forEach(a=>{e[a]=ra(U[a])}),e}function G(U,e,a={clone:!0}){const f=a.clone?g({},U):U;return fU(U)&&fU(e)&&Object.keys(e).forEach(c=>{c!=="__proto__"&&(fU(e[c])&&c in U&&fU(U[c])?f[c]=G(U[c],e[c],a):a.clone?f[c]=fU(e[c])?ra(e[c]):e[c]:f[c]=e[c])}),f}function na(U){if(typeof U!="string")throw new Error(sU(7));return U.charAt(0).toUpperCase()+U.slice(1)}const Df=["values","unit","step"],Gf=U=>{const e=Object.keys(U).map(a=>({key:a,val:U[a]}))||[];return e.sort((a,f)=>a.val-f.val),e.reduce((a,f)=>g({},a,{[f.key]:f.val}),{})};function Nf(U){const{values:e={xs:0,sm:600,md:900,lg:1200,xl:1536},unit:a="px",step:f=5}=U,c=X(U,Df),t=Gf(e),d=Object.keys(t);function r(i){return`@media (min-width:${typeof e[i]=="number"?e[i]:i}${a})`}function n(i){return`@media (max-width:${(typeof e[i]=="number"?e[i]:i)-f/100}${a})`}function b(i,y){const p=d.indexOf(y);return`@media (min-width:${typeof e[i]=="number"?e[i]:i}${a}) and (max-width:${(p!==-1&&typeof e[d[p]]=="number"?e[d[p]]:y)-f/100}${a})`}function l(i){return d.indexOf(i)+1<d.length?b(i,d[d.indexOf(i)+1]):r(i)}function s(i){const y=d.indexOf(i);return y===0?r(d[1]):y===d.length-1?n(d[y]):b(i,d[d.indexOf(i)+1]).replace("@media","@media not all and")}return g({keys:d,values:t,up:r,down:n,between:b,only:l,not:s,unit:a},c)}const qf={borderRadius:4},Xf=qf;function iU(U,e){return e?G(U,e,{clone:!1}):U}const be={xs:0,sm:600,md:900,lg:1200,xl:1536},$e={keys:["xs","sm","md","lg","xl"],up:U=>`@media (min-width:${be[U]}px)`};function q(U,e,a){const f=U.theme||{};if(Array.isArray(e)){const t=f.breakpoints||$e;return e.reduce((d,r,n)=>(d[t.up(t.keys[n])]=a(e[n]),d),{})}if(typeof e=="object"){const t=f.breakpoints||$e;return Object.keys(e).reduce((d,r)=>{if(Object.keys(t.values||be).indexOf(r)!==-1){const n=t.up(r);d[n]=a(e[r],r)}else{const n=r;d[n]=e[n]}return d},{})}return a(e)}function Yf(U={}){var e;return((e=U.keys)==null?void 0:e.reduce((f,c)=>{const t=U.up(c);return f[t]={},f},{}))||{}}function Zf(U,e){return U.reduce((a,f)=>{const c=a[f];return(!c||Object.keys(c).length===0)&&delete a[f],a},e)}function jU(U,e,a=!0){if(!e||typeof e!="string")return null;if(U&&U.vars&&a){const f=`vars.${e}`.split(".").reduce((c,t)=>c&&c[t]?c[t]:null,U);if(f!=null)return f}return e.split(".").reduce((f,c)=>f&&f[c]!=null?f[c]:null,U)}function SU(U,e,a,f=a){let c;return typeof U=="function"?c=U(a):Array.isArray(U)?c=U[a]||f:c=jU(U,a)||f,e&&(c=e(c,f,U)),c}function k(U){const{prop:e,cssProperty:a=U.prop,themeKey:f,transform:c}=U,t=d=>{if(d[e]==null)return null;const r=d[e],n=d.theme,b=jU(n,f)||{};return q(d,r,s=>{let i=SU(b,c,s);return s===i&&typeof s=="string"&&(i=SU(b,c,`${e}${s==="default"?"":na(s)}`,s)),a===!1?i:{[a]:i}})};return t.propTypes={},t.filterProps=[e],t}function Qf(U){const e={};return a=>(e[a]===void 0&&(e[a]=U(a)),e[a])}const Uc={m:"margin",p:"padding"},ec={t:"Top",r:"Right",b:"Bottom",l:"Left",x:["Left","Right"],y:["Top","Bottom"]},ke={marginX:"mx",marginY:"my",paddingX:"px",paddingY:"py"},ac=Qf(U=>{if(U.length>2)if(ke[U])U=ke[U];else return[U];const[e,a]=U.split(""),f=Uc[e],c=ec[a]||"";return Array.isArray(c)?c.map(t=>f+t):[f+c]}),ie=["m","mt","mr","mb","ml","mx","my","margin","marginTop","marginRight","marginBottom","marginLeft","marginX","marginY","marginInline","marginInlineStart","marginInlineEnd","marginBlock","marginBlockStart","marginBlockEnd"],se=["p","pt","pr","pb","pl","px","py","padding","paddingTop","paddingRight","paddingBottom","paddingLeft","paddingX","paddingY","paddingInline","paddingInlineStart","paddingInlineEnd","paddingBlock","paddingBlockStart","paddingBlockEnd"];[...ie,...se];function yU(U,e,a,f){var c;const t=(c=jU(U,e,!1))!=null?c:a;return typeof t=="number"?d=>typeof d=="string"?d:t*d:Array.isArray(t)?d=>typeof d=="string"?d:t[d]:typeof t=="function"?t:()=>{}}function oa(U){return yU(U,"spacing",8)}function hU(U,e){if(typeof e=="string"||e==null)return e;const a=Math.abs(e),f=U(a);return e>=0?f:typeof f=="number"?-f:`-${f}`}function fc(U,e){return a=>U.reduce((f,c)=>(f[c]=hU(e,a),f),{})}function cc(U,e,a,f){if(e.indexOf(a)===-1)return null;const c=ac(a),t=fc(c,f),d=U[a];return q(U,d,t)}function ba(U,e){const a=oa(U.theme);return Object.keys(U).map(f=>cc(U,e,f,a)).reduce(iU,{})}function V(U){return ba(U,ie)}V.propTypes={};V.filterProps=ie;function J(U){return ba(U,se)}J.propTypes={};J.filterProps=se;function tc(U=8){if(U.mui)return U;const e=oa({spacing:U}),a=(...f)=>(f.length===0?[1]:f).map(t=>{const d=e(t);return typeof d=="number"?`${d}px`:d}).join(" ");return a.mui=!0,a}function IU(...U){const e=U.reduce((f,c)=>(c.filterProps.forEach(t=>{f[t]=c}),f),{}),a=f=>Object.keys(f).reduce((c,t)=>e[t]?iU(c,e[t](f)):c,{});return a.propTypes={},a.filterProps=U.reduce((f,c)=>f.concat(c.filterProps),[]),a}function E(U){return typeof U!="number"?U:`${U}px solid`}function j(U,e){return k({prop:U,themeKey:"borders",transform:e})}const dc=j("border",E),rc=j("borderTop",E),nc=j("borderRight",E),oc=j("borderBottom",E),bc=j("borderLeft",E),ic=j("borderColor"),sc=j("borderTopColor"),lc=j("borderRightColor"),pc=j("borderBottomColor"),uc=j("borderLeftColor"),mc=j("outline",E),gc=j("outlineColor"),LU=U=>{if(U.borderRadius!==void 0&&U.borderRadius!==null){const e=yU(U.theme,"shape.borderRadius",4),a=f=>({borderRadius:hU(e,f)});return q(U,U.borderRadius,a)}return null};LU.propTypes={};LU.filterProps=["borderRadius"];IU(dc,rc,nc,oc,bc,ic,sc,lc,pc,uc,LU,mc,gc);const KU=U=>{if(U.gap!==void 0&&U.gap!==null){const e=yU(U.theme,"spacing",8),a=f=>({gap:hU(e,f)});return q(U,U.gap,a)}return null};KU.propTypes={};KU.filterProps=["gap"];const FU=U=>{if(U.columnGap!==void 0&&U.columnGap!==null){const e=yU(U.theme,"spacing",8),a=f=>({columnGap:hU(e,f)});return q(U,U.columnGap,a)}return null};FU.propTypes={};FU.filterProps=["columnGap"];const DU=U=>{if(U.rowGap!==void 0&&U.rowGap!==null){const e=yU(U.theme,"spacing",8),a=f=>({rowGap:hU(e,f)});return q(U,U.rowGap,a)}return null};DU.propTypes={};DU.filterProps=["rowGap"];const yc=k({prop:"gridColumn"}),hc=k({prop:"gridRow"}),wc=k({prop:"gridAutoFlow"}),Pc=k({prop:"gridAutoColumns"}),vc=k({prop:"gridAutoRows"}),xc=k({prop:"gridTemplateColumns"}),Vc=k({prop:"gridTemplateRows"}),Jc=k({prop:"gridTemplateAreas"}),Sc=k({prop:"gridArea"});IU(KU,FU,DU,yc,hc,wc,Pc,vc,xc,Vc,Jc,Sc);function tU(U,e){return e==="grey"?e:U}const $c=k({prop:"color",themeKey:"palette",transform:tU}),kc=k({prop:"bgcolor",cssProperty:"backgroundColor",themeKey:"palette",transform:tU}),Cc=k({prop:"backgroundColor",themeKey:"palette",transform:tU});IU($c,kc,Cc);function _(U){return U<=1&&U!==0?`${U*100}%`:U}const Tc=k({prop:"width",transform:_}),le=U=>{if(U.maxWidth!==void 0&&U.maxWidth!==null){const e=a=>{var f,c;const t=((f=U.theme)==null||(f=f.breakpoints)==null||(f=f.values)==null?void 0:f[a])||be[a];return t?((c=U.theme)==null||(c=c.breakpoints)==null?void 0:c.unit)!=="px"?{maxWidth:`${t}${U.theme.breakpoints.unit}`}:{maxWidth:t}:{maxWidth:_(a)}};return q(U,U.maxWidth,e)}return null};le.filterProps=["maxWidth"];const Oc=k({prop:"minWidth",transform:_}),Mc=k({prop:"height",transform:_}),Ac=k({prop:"maxHeight",transform:_}),Rc=k({prop:"minHeight",transform:_});k({prop:"size",cssProperty:"width",transform:_});k({prop:"size",cssProperty:"height",transform:_});const _c=k({prop:"boxSizing"});IU(Tc,le,Oc,Mc,Ac,Rc,_c);const zc={border:{themeKey:"borders",transform:E},borderTop:{themeKey:"borders",transform:E},borderRight:{themeKey:"borders",transform:E},borderBottom:{themeKey:"borders",transform:E},borderLeft:{themeKey:"borders",transform:E},borderColor:{themeKey:"palette"},borderTopColor:{themeKey:"palette"},borderRightColor:{themeKey:"palette"},borderBottomColor:{themeKey:"palette"},borderLeftColor:{themeKey:"palette"},outline:{themeKey:"borders",transform:E},outlineColor:{themeKey:"palette"},borderRadius:{themeKey:"shape.borderRadius",style:LU},color:{themeKey:"palette",transform:tU},bgcolor:{themeKey:"palette",cssProperty:"backgroundColor",transform:tU},backgroundColor:{themeKey:"palette",transform:tU},p:{style:J},pt:{style:J},pr:{style:J},pb:{style:J},pl:{style:J},px:{style:J},py:{style:J},padding:{style:J},paddingTop:{style:J},paddingRight:{style:J},paddingBottom:{style:J},paddingLeft:{style:J},paddingX:{style:J},paddingY:{style:J},paddingInline:{style:J},paddingInlineStart:{style:J},paddingInlineEnd:{style:J},paddingBlock:{style:J},paddingBlockStart:{style:J},paddingBlockEnd:{style:J},m:{style:V},mt:{style:V},mr:{style:V},mb:{style:V},ml:{style:V},mx:{style:V},my:{style:V},margin:{style:V},marginTop:{style:V},marginRight:{style:V},marginBottom:{style:V},marginLeft:{style:V},marginX:{style:V},marginY:{style:V},marginInline:{style:V},marginInlineStart:{style:V},marginInlineEnd:{style:V},marginBlock:{style:V},marginBlockStart:{style:V},marginBlockEnd:{style:V},displayPrint:{cssProperty:!1,transform:U=>({"@media print":{display:U}})},display:{},overflow:{},textOverflow:{},visibility:{},whiteSpace:{},flexBasis:{},flexDirection:{},flexWrap:{},justifyContent:{},alignItems:{},alignContent:{},order:{},flex:{},flexGrow:{},flexShrink:{},alignSelf:{},justifyItems:{},justifySelf:{},gap:{style:KU},rowGap:{style:DU},columnGap:{style:FU},gridColumn:{},gridRow:{},gridAutoFlow:{},gridAutoColumns:{},gridAutoRows:{},gridTemplateColumns:{},gridTemplateRows:{},gridTemplateAreas:{},gridArea:{},position:{},zIndex:{themeKey:"zIndex"},top:{},right:{},bottom:{},left:{},boxShadow:{themeKey:"shadows"},width:{transform:_},maxWidth:{style:le},minWidth:{transform:_},height:{transform:_},maxHeight:{transform:_},minHeight:{transform:_},boxSizing:{},fontFamily:{themeKey:"typography"},fontSize:{themeKey:"typography"},fontStyle:{themeKey:"typography"},fontWeight:{themeKey:"typography"},letterSpacing:{},textTransform:{},lineHeight:{},textAlign:{},typography:{cssProperty:!1,themeKey:"typography"}},pe=zc;function Bc(...U){const e=U.reduce((f,c)=>f.concat(Object.keys(c)),[]),a=new Set(e);return U.every(f=>a.size===Object.keys(f).length)}function Ec(U,e){return typeof U=="function"?U(e):U}function Wc(){function U(a,f,c,t){const d={[a]:f,theme:c},r=t[a];if(!r)return{[a]:f};const{cssProperty:n=a,themeKey:b,transform:l,style:s}=r;if(f==null)return null;if(b==="typography"&&f==="inherit")return{[a]:f};const i=jU(c,b)||{};return s?s(d):q(d,f,p=>{let o=SU(i,l,p);return p===o&&typeof p=="string"&&(o=SU(i,l,`${a}${p==="default"?"":na(p)}`,p)),n===!1?o:{[n]:o}})}function e(a){var f;const{sx:c,theme:t={}}=a||{};if(!c)return null;const d=(f=t.unstable_sxConfig)!=null?f:pe;function r(n){let b=n;if(typeof n=="function")b=n(t);else if(typeof n!="object")return n;if(!b)return null;const l=Yf(t.breakpoints),s=Object.keys(l);let i=l;return Object.keys(b).forEach(y=>{const p=Ec(b[y],t);if(p!=null)if(typeof p=="object")if(d[y])i=iU(i,U(y,p,t,d));else{const o=q({theme:t},p,v=>({[y]:v}));Bc(o,p)?i[y]=e({sx:p,theme:t}):i=iU(i,o)}else i=iU(i,U(y,p,t,d))}),Zf(s,i)}return Array.isArray(c)?c.map(r):r(c)}return e}const ia=Wc();ia.filterProps=["sx"];const sa=ia;function Hc(U,e){const a=this;return a.vars&&typeof a.getColorSchemeSelector=="function"?{[a.getColorSchemeSelector(U).replace(/(\[[^\]]+\])/,"*:where($1)")]:e}:a.palette.mode===U?e:{}}const jc=["breakpoints","palette","spacing","shape"];function la(U={},...e){const{breakpoints:a={},palette:f={},spacing:c,shape:t={}}=U,d=X(U,jc),r=Nf(a),n=tc(c);let b=G({breakpoints:r,direction:"ltr",components:{},palette:g({mode:"light"},f),spacing:n,shape:g({},Xf,t)},d);return b.applyStyles=Hc,b=e.reduce((l,s)=>G(l,s),b),b.unstable_sxConfig=g({},pe,d==null?void 0:d.unstable_sxConfig),b.unstable_sx=function(s){return sa({sx:s,theme:this})},b}function Ic(U,e){return g({toolbar:{minHeight:56,[U.up("xs")]:{"@media (orientation: landscape)":{minHeight:48}},[U.up("sm")]:{minHeight:64}}},e)}const Lc={black:"#000",white:"#fff"},mU=Lc,Kc={50:"#fafafa",100:"#f5f5f5",200:"#eeeeee",300:"#e0e0e0",400:"#bdbdbd",500:"#9e9e9e",600:"#757575",700:"#616161",800:"#424242",900:"#212121",A100:"#f5f5f5",A200:"#eeeeee",A400:"#bdbdbd",A700:"#616161"},Fc=Kc,Dc={50:"#f3e5f5",100:"#e1bee7",200:"#ce93d8",300:"#ba68c8",400:"#ab47bc",500:"#9c27b0",600:"#8e24aa",700:"#7b1fa2",800:"#6a1b9a",900:"#4a148c",A100:"#ea80fc",A200:"#e040fb",A400:"#d500f9",A700:"#aa00ff"},Z=Dc,Gc={50:"#ffebee",100:"#ffcdd2",200:"#ef9a9a",300:"#e57373",400:"#ef5350",500:"#f44336",600:"#e53935",700:"#d32f2f",800:"#c62828",900:"#b71c1c",A100:"#ff8a80",A200:"#ff5252",A400:"#ff1744",A700:"#d50000"},Q=Gc,Nc={50:"#fff3e0",100:"#ffe0b2",200:"#ffcc80",300:"#ffb74d",400:"#ffa726",500:"#ff9800",600:"#fb8c00",700:"#f57c00",800:"#ef6c00",900:"#e65100",A100:"#ffd180",A200:"#ffab40",A400:"#ff9100",A700:"#ff6d00"},bU=Nc,qc={50:"#e3f2fd",100:"#bbdefb",200:"#90caf9",300:"#64b5f6",400:"#42a5f5",500:"#2196f3",600:"#1e88e5",700:"#1976d2",800:"#1565c0",900:"#0d47a1",A100:"#82b1ff",A200:"#448aff",A400:"#2979ff",A700:"#2962ff"},UU=qc,Xc={50:"#e1f5fe",100:"#b3e5fc",200:"#81d4fa",300:"#4fc3f7",400:"#29b6f6",500:"#03a9f4",600:"#039be5",700:"#0288d1",800:"#0277bd",900:"#01579b",A100:"#80d8ff",A200:"#40c4ff",A400:"#00b0ff",A700:"#0091ea"},eU=Xc,Yc={50:"#e8f5e9",100:"#c8e6c9",200:"#a5d6a7",300:"#81c784",400:"#66bb6a",500:"#4caf50",600:"#43a047",700:"#388e3c",800:"#2e7d32",900:"#1b5e20",A100:"#b9f6ca",A200:"#69f0ae",A400:"#00e676",A700:"#00c853"},aU=Yc,Zc=["mode","contrastThreshold","tonalOffset"],Ce={text:{primary:"rgba(0, 0, 0, 0.87)",secondary:"rgba(0, 0, 0, 0.6)",disabled:"rgba(0, 0, 0, 0.38)"},divider:"rgba(0, 0, 0, 0.12)",background:{paper:mU.white,default:mU.white},action:{active:"rgba(0, 0, 0, 0.54)",hover:"rgba(0, 0, 0, 0.04)",hoverOpacity:.04,selected:"rgba(0, 0, 0, 0.08)",selectedOpacity:.08,disabled:"rgba(0, 0, 0, 0.26)",disabledBackground:"rgba(0, 0, 0, 0.12)",disabledOpacity:.38,focus:"rgba(0, 0, 0, 0.12)",focusOpacity:.12,activatedOpacity:.12}},qU={text:{primary:mU.white,secondary:"rgba(255, 255, 255, 0.7)",disabled:"rgba(255, 255, 255, 0.5)",icon:"rgba(255, 255, 255, 0.5)"},divider:"rgba(255, 255, 255, 0.12)",background:{paper:"#121212",default:"#121212"},action:{active:mU.white,hover:"rgba(255, 255, 255, 0.08)",hoverOpacity:.08,selected:"rgba(255, 255, 255, 0.16)",selectedOpacity:.16,disabled:"rgba(255, 255, 255, 0.3)",disabledBackground:"rgba(255, 255, 255, 0.12)",disabledOpacity:.38,focus:"rgba(255, 255, 255, 0.12)",focusOpacity:.12,activatedOpacity:.24}};function Te(U,e,a,f){const c=f.light||f,t=f.dark||f*1.5;U[e]||(U.hasOwnProperty(a)?U[e]=U[a]:e==="light"?U.light=Ta(U.main,c):e==="dark"&&(U.dark=ka(U.main,t)))}function Qc(U="light"){return U==="dark"?{main:UU[200],light:UU[50],dark:UU[400]}:{main:UU[700],light:UU[400],dark:UU[800]}}function Ut(U="light"){return U==="dark"?{main:Z[200],light:Z[50],dark:Z[400]}:{main:Z[500],light:Z[300],dark:Z[700]}}function et(U="light"){return U==="dark"?{main:Q[500],light:Q[300],dark:Q[700]}:{main:Q[700],light:Q[400],dark:Q[800]}}function at(U="light"){return U==="dark"?{main:eU[400],light:eU[300],dark:eU[700]}:{main:eU[700],light:eU[500],dark:eU[900]}}function ft(U="light"){return U==="dark"?{main:aU[400],light:aU[300],dark:aU[700]}:{main:aU[800],light:aU[500],dark:aU[900]}}function ct(U="light"){return U==="dark"?{main:bU[400],light:bU[300],dark:bU[700]}:{main:"#ed6c02",light:bU[500],dark:bU[900]}}function tt(U){const{mode:e="light",contrastThreshold:a=3,tonalOffset:f=.2}=U,c=X(U,Zc),t=U.primary||Qc(e),d=U.secondary||Ut(e),r=U.error||et(e),n=U.info||at(e),b=U.success||ft(e),l=U.warning||ct(e);function s(o){return Ca(o,qU.text.primary)>=a?qU.text.primary:Ce.text.primary}const i=({color:o,name:v,mainShade:w=500,lightShade:S=300,darkShade:A=700})=>{if(o=g({},o),!o.main&&o[w]&&(o.main=o[w]),!o.hasOwnProperty("main"))throw new Error(sU(11,v?` (${v})`:"",w));if(typeof o.main!="string")throw new Error(sU(12,v?` (${v})`:"",JSON.stringify(o.main)));return Te(o,"light",S,f),Te(o,"dark",A,f),o.contrastText||(o.contrastText=s(o.main)),o},y={dark:qU,light:Ce};return G(g({common:g({},mU),mode:e,primary:i({color:t,name:"primary"}),secondary:i({color:d,name:"secondary",mainShade:"A400",lightShade:"A200",darkShade:"A700"}),error:i({color:r,name:"error"}),warning:i({color:l,name:"warning"}),info:i({color:n,name:"info"}),success:i({color:b,name:"success"}),grey:Fc,contrastThreshold:a,getContrastText:s,augmentColor:i,tonalOffset:f},y[e]),c)}const dt=["fontFamily","fontSize","fontWeightLight","fontWeightRegular","fontWeightMedium","fontWeightBold","htmlFontSize","allVariants","pxToRem"];function rt(U){return Math.round(U*1e5)/1e5}const Oe={textTransform:"uppercase"},Me='"Roboto", "Helvetica", "Arial", sans-serif';function nt(U,e){const a=typeof e=="function"?e(U):e,{fontFamily:f=Me,fontSize:c=14,fontWeightLight:t=300,fontWeightRegular:d=400,fontWeightMedium:r=500,fontWeightBold:n=700,htmlFontSize:b=16,allVariants:l,pxToRem:s}=a,i=X(a,dt),y=c/14,p=s||(w=>`${w/b*y}rem`),o=(w,S,A,Y,D)=>g({fontFamily:f,fontWeight:w,fontSize:p(S),lineHeight:A},f===Me?{letterSpacing:`${rt(Y/S)}em`}:{},D,l),v={h1:o(t,96,1.167,-1.5),h2:o(t,60,1.2,-.5),h3:o(d,48,1.167,0),h4:o(d,34,1.235,.25),h5:o(d,24,1.334,0),h6:o(r,20,1.6,.15),subtitle1:o(d,16,1.75,.15),subtitle2:o(r,14,1.57,.1),body1:o(d,16,1.5,.15),body2:o(d,14,1.43,.15),button:o(r,14,1.75,.4,Oe),caption:o(d,12,1.66,.4),overline:o(d,12,2.66,1,Oe),inherit:{fontFamily:"inherit",fontWeight:"inherit",fontSize:"inherit",lineHeight:"inherit",letterSpacing:"inherit"}};return G(g({htmlFontSize:b,pxToRem:p,fontFamily:f,fontSize:c,fontWeightLight:t,fontWeightRegular:d,fontWeightMedium:r,fontWeightBold:n},v),i,{clone:!1})}const ot=.2,bt=.14,it=.12;function x(...U){return[`${U[0]}px ${U[1]}px ${U[2]}px ${U[3]}px rgba(0,0,0,${ot})`,`${U[4]}px ${U[5]}px ${U[6]}px ${U[7]}px rgba(0,0,0,${bt})`,`${U[8]}px ${U[9]}px ${U[10]}px ${U[11]}px rgba(0,0,0,${it})`].join(",")}const st=["none",x(0,2,1,-1,0,1,1,0,0,1,3,0),x(0,3,1,-2,0,2,2,0,0,1,5,0),x(0,3,3,-2,0,3,4,0,0,1,8,0),x(0,2,4,-1,0,4,5,0,0,1,10,0),x(0,3,5,-1,0,5,8,0,0,1,14,0),x(0,3,5,-1,0,6,10,0,0,1,18,0),x(0,4,5,-2,0,7,10,1,0,2,16,1),x(0,5,5,-3,0,8,10,1,0,3,14,2),x(0,5,6,-3,0,9,12,1,0,3,16,2),x(0,6,6,-3,0,10,14,1,0,4,18,3),x(0,6,7,-4,0,11,15,1,0,4,20,3),x(0,7,8,-4,0,12,17,2,0,5,22,4),x(0,7,8,-4,0,13,19,2,0,5,24,4),x(0,7,9,-4,0,14,21,2,0,5,26,4),x(0,8,9,-5,0,15,22,2,0,6,28,5),x(0,8,10,-5,0,16,24,2,0,6,30,5),x(0,8,11,-5,0,17,26,2,0,6,32,5),x(0,9,11,-5,0,18,28,2,0,7,34,6),x(0,9,12,-6,0,19,29,2,0,7,36,6),x(0,10,13,-6,0,20,31,3,0,8,38,7),x(0,10,13,-6,0,21,33,3,0,8,40,7),x(0,10,14,-6,0,22,35,3,0,8,42,7),x(0,11,14,-7,0,23,36,3,0,9,44,8),x(0,11,15,-7,0,24,38,3,0,9,46,8)],lt=st,pt=["duration","easing","delay"],ut={easeInOut:"cubic-bezier(0.4, 0, 0.2, 1)",easeOut:"cubic-bezier(0.0, 0, 0.2, 1)",easeIn:"cubic-bezier(0.4, 0, 1, 1)",sharp:"cubic-bezier(0.4, 0, 0.6, 1)"},mt={shortest:150,shorter:200,short:250,standard:300,complex:375,enteringScreen:225,leavingScreen:195};function Ae(U){return`${Math.round(U)}ms`}function gt(U){if(!U)return 0;const e=U/36;return Math.round((4+15*e**.25+e/5)*10)}function yt(U){const e=g({},ut,U.easing),a=g({},mt,U.duration);return g({getAutoHeightDuration:gt,create:(c=["all"],t={})=>{const{duration:d=a.standard,easing:r=e.easeInOut,delay:n=0}=t;return X(t,pt),(Array.isArray(c)?c:[c]).map(b=>`${b} ${typeof d=="string"?d:Ae(d)} ${r} ${typeof n=="string"?n:Ae(n)}`).join(",")}},U,{easing:e,duration:a})}const ht={mobileStepper:1e3,fab:1050,speedDial:1050,appBar:1100,drawer:1200,modal:1300,snackbar:1400,tooltip:1500},wt=ht,Pt=["breakpoints","mixins","spacing","palette","transitions","typography","shape"];function pa(U={},...e){const{mixins:a={},palette:f={},transitions:c={},typography:t={}}=U,d=X(U,Pt);if(U.vars)throw new Error(sU(18));const r=tt(f),n=la(U);let b=G(n,{mixins:Ic(n.breakpoints,a),palette:r,shadows:lt.slice(),typography:nt(r,t),transitions:yt(c),zIndex:g({},wt)});return b=G(b,d),b=e.reduce((l,s)=>G(l,s),b),b.unstable_sxConfig=g({},pe,d==null?void 0:d.unstable_sxConfig),b.unstable_sx=function(s){return sa({sx:s,theme:this})},b}const vt=pa(),ua=vt,$U="$$material";function xt(U){const{theme:e,name:a,props:f}=U;return!e||!e.components||!e.components[a]||!e.components[a].defaultProps?f:We(e.components[a].defaultProps,f)}function Vt(U){return Object.keys(U).length===0}function ma(U=null){const e=W.useContext(oe);return!e||Vt(e)?U:e}const Jt=la();function ga(U=Jt){return ma(U)}function St({props:U,name:e,defaultTheme:a,themeId:f}){let c=ga(a);return f&&(c=c[f]||c),xt({theme:c,name:e,props:U})}function $t({props:U,name:e}){return St({props:U,name:e,defaultTheme:ua,themeId:$U})}function kt({styles:U,themeId:e,defaultTheme:a={}}){const f=ga(a),c=typeof U=="function"?U(e&&f[e]||f):U;return N(Ff,{styles:c})}const Ct=W.createContext(null),ya=Ct;function ha(){return W.useContext(ya)}const Tt=typeof Symbol=="function"&&Symbol.for,Ot=Tt?Symbol.for("mui.nested"):"__THEME_NESTED__";function Mt(U,e){return typeof e=="function"?e(U):g({},U,e)}function At(U){const{children:e,theme:a}=U,f=ha(),c=W.useMemo(()=>{const t=f===null?a:Mt(f,a);return t!=null&&(t[Ot]=f!==null),t},[a,f]);return N(ya.Provider,{value:c,children:e})}const Re={};function _e(U,e,a,f=!1){return W.useMemo(()=>{const c=U&&e[U]||e;if(typeof a=="function"){const t=a(c),d=U?g({},e,{[U]:t}):t;return f?()=>d:d}return U?g({},e,{[U]:a}):g({},e,a)},[U,e,a,f])}function Rt(U){const{children:e,theme:a,themeId:f}=U,c=ma(Re),t=ha()||Re,d=_e(f,c,a),r=_e(f,t,a,!0);return N(At,{theme:r,children:N(oe.Provider,{value:d,children:e})})}const _t=["theme"];function zt(U){let{theme:e}=U,a=X(U,_t);const f=e[$U];return N(Rt,g({},a,{themeId:f?$U:void 0,theme:f||e}))}function Bt(U){return N(kt,g({},U,{defaultTheme:ua,themeId:$U}))}const Et=(U,e)=>g({WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale",boxSizing:"border-box",WebkitTextSizeAdjust:"100%"},e&&!U.vars&&{colorScheme:U.palette.mode}),Wt=U=>g({color:(U.vars||U).palette.text.primary},U.typography.body1,{backgroundColor:(U.vars||U).palette.background.default,"@media print":{backgroundColor:(U.vars||U).palette.common.white}}),Ht=(U,e=!1)=>{var a;const f={};e&&U.colorSchemes&&Object.entries(U.colorSchemes).forEach(([d,r])=>{var n;f[U.getColorSchemeSelector(d).replace(/\s*&/,"")]={colorScheme:(n=r.palette)==null?void 0:n.mode}});let c=g({html:Et(U,e),"*, *::before, *::after":{boxSizing:"inherit"},"strong, b":{fontWeight:U.typography.fontWeightBold},body:g({margin:0},Wt(U),{"&::backdrop":{backgroundColor:(U.vars||U).palette.background.default}})},f);const t=(a=U.components)==null||(a=a.MuiCssBaseline)==null?void 0:a.styleOverrides;return t&&(c=[c,t]),c};function jt(U){const e=$t({props:U,name:"MuiCssBaseline"}),{children:a,enableColorScheme:f=!1}=e;return Be(W.Fragment,{children:[N(Bt,{styles:c=>Ht(c,f)}),a]})}const It={"typography/headline/h1/black":{fontSize:"40px",fontWeight:800,lineHeight:"56px"},"typography/headline/h1/bold":{fontSize:"40px",fontWeight:700,lineHeight:"56px"},"typography/headline/h1/medium":{fontSize:"40px",fontWeight:600,lineHeight:"56px"},"typography/headline/h1/regular":{fontSize:"40px",fontWeight:400,lineHeight:"56px"},"typography/headline/h2/black":{fontSize:"36px",fontWeight:800,lineHeight:"48px"},"typography/headline/h2/bold":{fontSize:"36px",fontWeight:700,lineHeight:"48px"},"typography/headline/h2/medium":{fontSize:"36px",fontWeight:600,lineHeight:"48px"},"typography/headline/h2/regular":{fontSize:"36px",fontWeight:400,lineHeight:"48px"},"typography/headline/h3/black":{fontSize:"32px",fontWeight:800,lineHeight:"42px"},"typography/headline/h3/bold":{fontSize:"32px",fontWeight:700,lineHeight:"42px"},"typography/headline/h3/medium":{fontSize:"32px",fontWeight:600,lineHeight:"42px"},"typography/headline/h3/regular":{fontSize:"32px",fontWeight:400,lineHeight:"42px"},"typography/headline/h4/black":{fontSize:"30px",fontWeight:800,lineHeight:"40px"},"typography/headline/h4/bold":{fontSize:"30px",fontWeight:700,lineHeight:"40px"},"typography/headline/h4/medium":{fontSize:"30px",fontWeight:600,lineHeight:"40px"},"typography/headline/h4/regular":{fontSize:"30px",fontWeight:400,lineHeight:"40px"},"typography/title/large/black":{fontSize:"28px",fontWeight:900,lineHeight:"36px"},"typography/title/large/bold":{fontSize:"28px",fontWeight:700,lineHeight:"36px"},"typography/title/large/medium":{fontSize:"28px",fontWeight:400,lineHeight:"36px"},"typography/title/large/regular":{fontSize:"28px",fontWeight:400,lineHeight:"36px"},"typography/title/medium/black":{fontSize:"24px",fontWeight:800,lineHeight:"32px"},"typography/title/medium/bold":{fontSize:"24px",fontWeight:700,lineHeight:"32px"},"typography/title/medium/medium":{fontSize:"24px",fontWeight:600,lineHeight:"32px"},"typography/title/medium/regular":{fontSize:"24px",fontWeight:400,lineHeight:"32px"},"typography/title/small/black":{fontSize:"20px",fontWeight:900,lineHeight:"28px"},"typography/title/small/bold":{fontSize:"20px",fontWeight:700,lineHeight:"28px"},"typography/title/small/medium":{fontSize:"20px",fontWeight:600,lineHeight:"28px"},"typography/title/small/regular":{fontSize:"20px",fontWeight:400,lineHeight:"28px"},"typography/body/medium/black":{fontSize:"16px",fontWeight:800,lineHeight:"24px"},"typography/body/medium/bold":{fontSize:"16px",fontWeight:700,lineHeight:"24px"},"typography/body/medium/medium":{fontSize:"16px",fontWeight:600,lineHeight:"24px"},"typography/body/medium/regular":{fontSize:"16px",fontWeight:400,lineHeight:"24px"},"typography/body/small/black":{fontSize:"14px",fontWeight:800,lineHeight:"20px"},"typography/body/small/bold":{fontSize:"14px",fontWeight:700,lineHeight:"20px"},"typography/body/small/medium":{fontSize:"14px",fontWeight:600,lineHeight:"20px"},"typography/body/small/regular":{fontSize:"14px",fontWeight:400,lineHeight:"20px"},"typography/label/large/black":{fontSize:"12px",fontWeight:800,lineHeight:"16px"},"typography/label/large/bold":{fontSize:"12px",fontWeight:700,lineHeight:"16px"},"typography/label/large/medium":{fontSize:"12px",fontWeight:600,lineHeight:"16px"},"typography/label/large/regular":{fontSize:"12px",fontWeight:400,lineHeight:"16px"},"typography/label/medium/black":{fontSize:"11px",fontWeight:800,lineHeight:"14px"},"typography/label/medium/bold":{fontSize:"11px",fontWeight:700,lineHeight:"14px"},"typography/label/medium/medium":{fontSize:"11px",fontWeight:600,lineHeight:"14px"},"typography/label/medium/regular":{fontSize:"11px",fontWeight:400,lineHeight:"14px"},"typography/label/small/black":{fontSize:"10px",fontWeight:800,lineHeight:"14px"},"typography/label/small/bold":{fontSize:"10px",fontWeight:700,lineHeight:"14px"},"typography/label/small/medium":{fontSize:"10px",fontWeight:600,lineHeight:"14px"},"typography/label/small/regular":{fontSize:"10px",fontWeight:400,lineHeight:"14px"}},Lt=`
