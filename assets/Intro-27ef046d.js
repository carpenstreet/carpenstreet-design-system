import{j as n,a as t,F as i}from"./jsx-runtime-29545a09.js";import{u as a}from"./index-a1cf9e47.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";const s=""+new URL("Storybook_Banner-9e734446.png",import.meta.url).href;function o(r){const e=Object.assign({h1:"h1",p:"p",a:"a",hr:"hr",strong:"strong",h2:"h2",h3:"h3",pre:"pre",code:"code"},a(),r.components);return t(i,{children:[n("img",{src:s,alt:"Banner image for stroybook",style:{marginBottom:"24px"}}),`
...
`,n(e.h3,{id:"installation",children:"Installation"}),`
`,n(e.p,{children:"우선, git repo를 clone해주세요"}),`
`,n(e.pre,{children:n(e.code,{className:"language-bash",children:`# install dependency
yarn install
`})}),`
`,n(e.h3,{id:"running-the-app",children:"Running the app"}),`
`,n(e.pre,{children:n(e.code,{className:"language-bash",children:`# run development mode
yarn dev
`})})]})}function p(r={}){const{wrapper:e}=Object.assign({},a(),r.components);return e?n(e,Object.assign({},r,{children:n(o,r)})):o(r)}export{p as default};
