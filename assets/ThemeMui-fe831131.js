import{j as q,a as Oe}from"./jsx-runtime-29545a09.js";import{r as ua}from"./color-d4584655.js";import{_ as g,a as le}from"./extends-623938b0.js";import{a as Ae}from"./_commonjsHelpers-de833af9.js";import{r as W}from"./index-76fb7be0.js";function X(U,e){if(U==null)return{};var a={},f=Object.keys(U),c,t;for(t=0;t<f.length;t++)c=f[t],!(e.indexOf(c)>=0)&&(a[c]=U[c]);return a}function Re(U,e){const a=g({},e);return Object.keys(U).forEach(f=>{if(f.toString().match(/^(components|slots)$/))a[f]=g({},U[f],a[f]);else if(f.toString().match(/^(componentsProps|slotProps)$/)){const c=U[f]||{},t=e[f];a[f]={},!t||!Object.keys(t)?a[f]=c:!c||!Object.keys(c)?a[f]=t:(a[f]=g({},t),Object.keys(c).forEach(d=>{a[f][d]=Re(c[d],t[d])}))}else a[f]===void 0&&(a[f]=U[f])}),a}var k={},ze={exports:{}};(function(U){function e(a){return a&&a.__esModule?a:{default:a}}U.exports=e,U.exports.__esModule=!0,U.exports.default=U.exports})(ze);var ma=ze.exports;function sU(U){let e="https://mui.com/production-error/?code="+U;for(let a=1;a<arguments.length;a+=1)e+="&args[]="+encodeURIComponent(arguments[a]);return"Minified MUI error #"+U+"; visit "+e+" for the full message."}const ga=Object.freeze(Object.defineProperty({__proto__:null,default:sU},Symbol.toStringTag,{value:"Module"})),ya=Ae(ga);function ha(U,e=Number.MIN_SAFE_INTEGER,a=Number.MAX_SAFE_INTEGER){return Math.max(e,Math.min(U,a))}const wa=Object.freeze(Object.defineProperty({__proto__:null,default:ha},Symbol.toStringTag,{value:"Module"})),Pa=Ae(wa);var Be=ma;Object.defineProperty(k,"__esModule",{value:!0});var Kt=k.alpha=He;k.blend=Ra;k.colorChannel=void 0;var xa=k.darken=QU;k.decomposeColor=H;k.emphasize=Aa;var va=k.getContrastRatio=Ca;k.getLuminance=VU;k.hexToRgb=_e;k.hslToRgb=We;var Va=k.lighten=Ue;k.private_safeAlpha=Ta;k.private_safeColorChannel=void 0;k.private_safeDarken=Ma;k.private_safeEmphasize=je;k.private_safeLighten=Oa;k.recomposeColor=rU;k.rgbToHex=$a;var pe=Be(ya),Ja=Be(Pa);function ZU(U,e=0,a=1){return(0,Ja.default)(U,e,a)}function _e(U){U=U.slice(1);const e=new RegExp(`.{1,${U.length>=6?2:1}}`,"g");let a=U.match(e);return a&&a[0].length===1&&(a=a.map(f=>f+f)),a?`rgb${a.length===4?"a":""}(${a.map((f,c)=>c<3?parseInt(f,16):Math.round(parseInt(f,16)/255*1e3)/1e3).join(", ")})`:""}function Sa(U){const e=U.toString(16);return e.length===1?`0${e}`:e}function H(U){if(U.type)return U;if(U.charAt(0)==="#")return H(_e(U));const e=U.indexOf("("),a=U.substring(0,e);if(["rgb","rgba","hsl","hsla","color"].indexOf(a)===-1)throw new Error((0,pe.default)(9,U));let f=U.substring(e+1,U.length-1),c;if(a==="color"){if(f=f.split(" "),c=f.shift(),f.length===4&&f[3].charAt(0)==="/"&&(f[3]=f[3].slice(1)),["srgb","display-p3","a98-rgb","prophoto-rgb","rec-2020"].indexOf(c)===-1)throw new Error((0,pe.default)(10,c))}else f=f.split(",");return f=f.map(t=>parseFloat(t)),{type:a,values:f,colorSpace:c}}const Ee=U=>{const e=H(U);return e.values.slice(0,3).map((a,f)=>e.type.indexOf("hsl")!==-1&&f!==0?`${a}%`:a).join(" ")};k.colorChannel=Ee;const ka=(U,e)=>{try{return Ee(U)}catch{return U}};k.private_safeColorChannel=ka;function rU(U){const{type:e,colorSpace:a}=U;let{values:f}=U;return e.indexOf("rgb")!==-1?f=f.map((c,t)=>t<3?parseInt(c,10):c):e.indexOf("hsl")!==-1&&(f[1]=`${f[1]}%`,f[2]=`${f[2]}%`),e.indexOf("color")!==-1?f=`${a} ${f.join(" ")}`:f=`${f.join(", ")}`,`${e}(${f})`}function $a(U){if(U.indexOf("#")===0)return U;const{values:e}=H(U);return`#${e.map((a,f)=>Sa(f===3?Math.round(255*a):a)).join("")}`}function We(U){U=H(U);const{values:e}=U,a=e[0],f=e[1]/100,c=e[2]/100,t=f*Math.min(c,1-c),d=(i,l=(i+a/30)%12)=>c-t*Math.max(Math.min(l-3,9-l,1),-1);let r="rgb";const o=[Math.round(d(0)*255),Math.round(d(8)*255),Math.round(d(4)*255)];return U.type==="hsla"&&(r+="a",o.push(e[3])),rU({type:r,values:o})}function VU(U){U=H(U);let e=U.type==="hsl"||U.type==="hsla"?H(We(U)).values:U.values;return e=e.map(a=>(U.type!=="color"&&(a/=255),a<=.03928?a/12.92:((a+.055)/1.055)**2.4)),Number((.2126*e[0]+.7152*e[1]+.0722*e[2]).toFixed(3))}function Ca(U,e){const a=VU(U),f=VU(e);return(Math.max(a,f)+.05)/(Math.min(a,f)+.05)}function He(U,e){return U=H(U),e=ZU(e),(U.type==="rgb"||U.type==="hsl")&&(U.type+="a"),U.type==="color"?U.values[3]=`/${e}`:U.values[3]=e,rU(U)}function Ta(U,e,a){try{return He(U,e)}catch{return U}}function QU(U,e){if(U=H(U),e=ZU(e),U.type.indexOf("hsl")!==-1)U.values[2]*=1-e;else if(U.type.indexOf("rgb")!==-1||U.type.indexOf("color")!==-1)for(let a=0;a<3;a+=1)U.values[a]*=1-e;return rU(U)}function Ma(U,e,a){try{return QU(U,e)}catch{return U}}function Ue(U,e){if(U=H(U),e=ZU(e),U.type.indexOf("hsl")!==-1)U.values[2]+=(100-U.values[2])*e;else if(U.type.indexOf("rgb")!==-1)for(let a=0;a<3;a+=1)U.values[a]+=(255-U.values[a])*e;else if(U.type.indexOf("color")!==-1)for(let a=0;a<3;a+=1)U.values[a]+=(1-U.values[a])*e;return rU(U)}function Oa(U,e,a){try{return Ue(U,e)}catch{return U}}function Aa(U,e=.15){return VU(U)>.5?QU(U,e):Ue(U,e)}function je(U,e,a){try{return je(U,e)}catch{return U}}function Ra(U,e,a,f=1){const c=(o,i)=>Math.round((o**(1/f)*(1-a)+i**(1/f)*a)**f),t=H(U),d=H(e),r=[c(t.values[0],d.values[0]),c(t.values[1],d.values[1]),c(t.values[2],d.values[2])];return rU({type:"rgb",values:r})}var DU={exports:{}},ue;function za(){return ue||(ue=1,function(U){function e(){return U.exports=e=Object.assign?Object.assign.bind():function(a){for(var f=1;f<arguments.length;f++){var c=arguments[f];for(var t in c)Object.prototype.hasOwnProperty.call(c,t)&&(a[t]=c[t])}return a},U.exports.__esModule=!0,U.exports.default=U.exports,e.apply(this,arguments)}U.exports=e,U.exports.__esModule=!0,U.exports.default=U.exports}(DU)),DU.exports}function Ba(U){var e=Object.create(null);return function(a){return e[a]===void 0&&(e[a]=U(a)),e[a]}}function _a(U){if(U.sheet)return U.sheet;for(var e=0;e<document.styleSheets.length;e++)if(document.styleSheets[e].ownerNode===U)return document.styleSheets[e]}function Ea(U){var e=document.createElement("style");return e.setAttribute("data-emotion",U.key),U.nonce!==void 0&&e.setAttribute("nonce",U.nonce),e.appendChild(document.createTextNode("")),e.setAttribute("data-s",""),e}var Wa=function(){function U(a){var f=this;this._insertTag=function(c){var t;f.tags.length===0?f.insertionPoint?t=f.insertionPoint.nextSibling:f.prepend?t=f.container.firstChild:t=f.before:t=f.tags[f.tags.length-1].nextSibling,f.container.insertBefore(c,t),f.tags.push(c)},this.isSpeedy=a.speedy===void 0?!0:a.speedy,this.tags=[],this.ctr=0,this.nonce=a.nonce,this.key=a.key,this.container=a.container,this.prepend=a.prepend,this.insertionPoint=a.insertionPoint,this.before=null}var e=U.prototype;return e.hydrate=function(f){f.forEach(this._insertTag)},e.insert=function(f){this.ctr%(this.isSpeedy?65e3:1)===0&&this._insertTag(Ea(this));var c=this.tags[this.tags.length-1];if(this.isSpeedy){var t=_a(c);try{t.insertRule(f,t.cssRules.length)}catch{}}else c.appendChild(document.createTextNode(f));this.ctr++},e.flush=function(){this.tags.forEach(function(f){return f.parentNode&&f.parentNode.removeChild(f)}),this.tags=[],this.ctr=0},U}(),O="-ms-",JU="-moz-",u="-webkit-",Ie="comm",ee="rule",ae="decl",Ha="@import",Le="@keyframes",ja="@layer",Ia=Math.abs,$U=String.fromCharCode,La=Object.assign;function Ka(U,e){return M(U,0)^45?(((e<<2^M(U,0))<<2^M(U,1))<<2^M(U,2))<<2^M(U,3):0}function Ke(U){return U.trim()}function Fa(U,e){return(U=e.exec(U))?U[0]:U}function m(U,e,a){return U.replace(e,a)}function XU(U,e){return U.indexOf(e)}function M(U,e){return U.charCodeAt(e)|0}function lU(U,e,a){return U.slice(e,a)}function L(U){return U.length}function fe(U){return U.length}function wU(U,e){return e.push(U),U}function Ga(U,e){return U.map(e).join("")}var CU=1,dU=1,Fe=0,R=0,C=0,oU="";function TU(U,e,a,f,c,t,d){return{value:U,root:e,parent:a,type:f,props:c,children:t,line:CU,column:dU,length:d,return:""}}function nU(U,e){return La(TU("",null,null,"",null,null,0),U,{length:-U.length},e)}function Da(){return C}function qa(){return C=R>0?M(oU,--R):0,dU--,C===10&&(dU=1,CU--),C}function B(){return C=R<Fe?M(oU,R++):0,dU++,C===10&&(dU=1,CU++),C}function F(){return M(oU,R)}function PU(){return R}function gU(U,e){return lU(oU,U,e)}function pU(U){switch(U){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function Ge(U){return CU=dU=1,Fe=L(oU=U),R=0,[]}function De(U){return oU="",U}function xU(U){return Ke(gU(R-1,YU(U===91?U+2:U===40?U+1:U)))}function Na(U){for(;(C=F())&&C<33;)B();return pU(U)>2||pU(C)>3?"":" "}function Xa(U,e){for(;--e&&B()&&!(C<48||C>102||C>57&&C<65||C>70&&C<97););return gU(U,PU()+(e<6&&F()==32&&B()==32))}function YU(U){for(;B();)switch(C){case U:return R;case 34:case 39:U!==34&&U!==39&&YU(C);break;case 40:U===41&&YU(U);break;case 92:B();break}return R}function Ya(U,e){for(;B()&&U+C!==47+10;)if(U+C===42+42&&F()===47)break;return"/*"+gU(e,R-1)+"*"+$U(U===47?U:B())}function Za(U){for(;!pU(F());)B();return gU(U,R)}function Qa(U){return De(vU("",null,null,null,[""],U=Ge(U),0,[0],U))}function vU(U,e,a,f,c,t,d,r,o){for(var i=0,l=0,s=d,b=0,y=0,p=0,n=1,x=1,w=1,S=0,A="",Y=c,G=t,I=f,P=A;x;)switch(p=S,S=B()){case 40:if(p!=108&&M(P,s-1)==58){XU(P+=m(xU(S),"&","&\f"),"&\f")!=-1&&(w=-1);break}case 34:case 39:case 91:P+=xU(S);break;case 9:case 10:case 13:case 32:P+=Na(p);break;case 92:P+=Xa(PU()-1,7);continue;case 47:switch(F()){case 42:case 47:wU(Uf(Ya(B(),PU()),e,a),o);break;default:P+="/"}break;case 123*n:r[i++]=L(P)*w;case 125*n:case 59:case 0:switch(S){case 0:case 125:x=0;case 59+l:w==-1&&(P=m(P,/\f/g,"")),y>0&&L(P)-s&&wU(y>32?ge(P+";",f,a,s-1):ge(m(P," ","")+";",f,a,s-2),o);break;case 59:P+=";";default:if(wU(I=me(P,e,a,i,l,c,r,A,Y=[],G=[],s),t),S===123)if(l===0)vU(P,e,I,I,Y,t,s,r,G);else switch(b===99&&M(P,3)===110?100:b){case 100:case 108:case 109:case 115:vU(U,I,I,f&&wU(me(U,I,I,0,0,c,r,A,c,Y=[],s),G),c,G,s,r,f?Y:G);break;default:vU(P,I,I,I,[""],G,0,r,G)}}i=l=y=0,n=w=1,A=P="",s=d;break;case 58:s=1+L(P),y=p;default:if(n<1){if(S==123)--n;else if(S==125&&n++==0&&qa()==125)continue}switch(P+=$U(S),S*n){case 38:w=l>0?1:(P+="\f",-1);break;case 44:r[i++]=(L(P)-1)*w,w=1;break;case 64:F()===45&&(P+=xU(B())),b=F(),l=s=L(A=P+=Za(PU())),S++;break;case 45:p===45&&L(P)==2&&(n=0)}}return t}function me(U,e,a,f,c,t,d,r,o,i,l){for(var s=c-1,b=c===0?t:[""],y=fe(b),p=0,n=0,x=0;p<f;++p)for(var w=0,S=lU(U,s+1,s=Ia(n=d[p])),A=U;w<y;++w)(A=Ke(n>0?b[w]+" "+S:m(S,/&\f/g,b[w])))&&(o[x++]=A);return TU(U,e,a,c===0?ee:r,o,i,l)}function Uf(U,e,a){return TU(U,e,a,Ie,$U(Da()),lU(U,2,-2),0)}function ge(U,e,a,f){return TU(U,e,a,ae,lU(U,0,f),lU(U,f+1,-1),f)}function cU(U,e){for(var a="",f=fe(U),c=0;c<f;c++)a+=e(U[c],c,U,e)||"";return a}function ef(U,e,a,f){switch(U.type){case ja:if(U.children.length)break;case Ha:case ae:return U.return=U.return||U.value;case Ie:return"";case Le:return U.return=U.value+"{"+cU(U.children,f)+"}";case ee:U.value=U.props.join(",")}return L(a=cU(U.children,f))?U.return=U.value+"{"+a+"}":""}function af(U){var e=fe(U);return function(a,f,c,t){for(var d="",r=0;r<e;r++)d+=U[r](a,f,c,t)||"";return d}}function ff(U){return function(e){e.root||(e=e.return)&&U(e)}}var cf=function(e,a,f){for(var c=0,t=0;c=t,t=F(),c===38&&t===12&&(a[f]=1),!pU(t);)B();return gU(e,R)},tf=function(e,a){var f=-1,c=44;do switch(pU(c)){case 0:c===38&&F()===12&&(a[f]=1),e[f]+=cf(R-1,a,f);break;case 2:e[f]+=xU(c);break;case 4:if(c===44){e[++f]=F()===58?"&\f":"",a[f]=e[f].length;break}default:e[f]+=$U(c)}while(c=B());return e},df=function(e,a){return De(tf(Ge(e),a))},ye=new WeakMap,rf=function(e){if(!(e.type!=="rule"||!e.parent||e.length<1)){for(var a=e.value,f=e.parent,c=e.column===f.column&&e.line===f.line;f.type!=="rule";)if(f=f.parent,!f)return;if(!(e.props.length===1&&a.charCodeAt(0)!==58&&!ye.get(f))&&!c){ye.set(e,!0);for(var t=[],d=df(a,t),r=f.props,o=0,i=0;o<d.length;o++)for(var l=0;l<r.length;l++,i++)e.props[i]=t[o]?d[o].replace(/&\f/g,r[l]):r[l]+" "+d[o]}}},of=function(e){if(e.type==="decl"){var a=e.value;a.charCodeAt(0)===108&&a.charCodeAt(2)===98&&(e.return="",e.value="")}};function qe(U,e){switch(Ka(U,e)){case 5103:return u+"print-"+U+U;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return u+U+U;case 5349:case 4246:case 4810:case 6968:case 2756:return u+U+JU+U+O+U+U;case 6828:case 4268:return u+U+O+U+U;case 6165:return u+U+O+"flex-"+U+U;case 5187:return u+U+m(U,/(\w+).+(:[^]+)/,u+"box-$1$2"+O+"flex-$1$2")+U;case 5443:return u+U+O+"flex-item-"+m(U,/flex-|-self/,"")+U;case 4675:return u+U+O+"flex-line-pack"+m(U,/align-content|flex-|-self/,"")+U;case 5548:return u+U+O+m(U,"shrink","negative")+U;case 5292:return u+U+O+m(U,"basis","preferred-size")+U;case 6060:return u+"box-"+m(U,"-grow","")+u+U+O+m(U,"grow","positive")+U;case 4554:return u+m(U,/([^-])(transform)/g,"$1"+u+"$2")+U;case 6187:return m(m(m(U,/(zoom-|grab)/,u+"$1"),/(image-set)/,u+"$1"),U,"")+U;case 5495:case 3959:return m(U,/(image-set\([^]*)/,u+"$1$`$1");case 4968:return m(m(U,/(.+:)(flex-)?(.*)/,u+"box-pack:$3"+O+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+u+U+U;case 4095:case 3583:case 4068:case 2532:return m(U,/(.+)-inline(.+)/,u+"$1$2")+U;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(L(U)-1-e>6)switch(M(U,e+1)){case 109:if(M(U,e+4)!==45)break;case 102:return m(U,/(.+:)(.+)-([^]+)/,"$1"+u+"$2-$3$1"+JU+(M(U,e+3)==108?"$3":"$2-$3"))+U;case 115:return~XU(U,"stretch")?qe(m(U,"stretch","fill-available"),e)+U:U}break;case 4949:if(M(U,e+1)!==115)break;case 6444:switch(M(U,L(U)-3-(~XU(U,"!important")&&10))){case 107:return m(U,":",":"+u)+U;case 101:return m(U,/(.+:)([^;!]+)(;|!.+)?/,"$1"+u+(M(U,14)===45?"inline-":"")+"box$3$1"+u+"$2$3$1"+O+"$2box$3")+U}break;case 5936:switch(M(U,e+11)){case 114:return u+U+O+m(U,/[svh]\w+-[tblr]{2}/,"tb")+U;case 108:return u+U+O+m(U,/[svh]\w+-[tblr]{2}/,"tb-rl")+U;case 45:return u+U+O+m(U,/[svh]\w+-[tblr]{2}/,"lr")+U}return u+U+O+U+U}return U}var nf=function(e,a,f,c){if(e.length>-1&&!e.return)switch(e.type){case ae:e.return=qe(e.value,e.length);break;case Le:return cU([nU(e,{value:m(e.value,"@","@"+u)})],c);case ee:if(e.length)return Ga(e.props,function(t){switch(Fa(t,/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":return cU([nU(e,{props:[m(t,/:(read-\w+)/,":"+JU+"$1")]})],c);case"::placeholder":return cU([nU(e,{props:[m(t,/:(plac\w+)/,":"+u+"input-$1")]}),nU(e,{props:[m(t,/:(plac\w+)/,":"+JU+"$1")]}),nU(e,{props:[m(t,/:(plac\w+)/,O+"input-$1")]})],c)}return""})}},bf=[nf],sf=function(e){var a=e.key;if(a==="css"){var f=document.querySelectorAll("style[data-emotion]:not([data-s])");Array.prototype.forEach.call(f,function(n){var x=n.getAttribute("data-emotion");x.indexOf(" ")!==-1&&(document.head.appendChild(n),n.setAttribute("data-s",""))})}var c=e.stylisPlugins||bf,t={},d,r=[];d=e.container||document.head,Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="'+a+' "]'),function(n){for(var x=n.getAttribute("data-emotion").split(" "),w=1;w<x.length;w++)t[x[w]]=!0;r.push(n)});var o,i=[rf,of];{var l,s=[ef,ff(function(n){l.insert(n)})],b=af(i.concat(c,s)),y=function(x){return cU(Qa(x),b)};o=function(x,w,S,A){l=S,y(x?x+"{"+w.styles+"}":w.styles),A&&(p.inserted[w.name]=!0)}}var p={key:a,sheet:new Wa({key:a,container:d,nonce:e.nonce,speedy:e.speedy,prepend:e.prepend,insertionPoint:e.insertionPoint}),nonce:e.nonce,inserted:t,registered:{},insert:o};return p.sheet.hydrate(r),p},Ne={exports:{}},h={};/** @license React v16.13.1
 ...
 */var T=typeof Symbol=="function"&&Symbol.for,ce=T?Symbol.for("react.element"):60103,te=T?Symbol.for("react.portal"):60106,MU=T?Symbol.for("react.fragment"):60107,OU=T?Symbol.for("react.strict_mode"):60108,AU=T?Symbol.for("react.profiler"):60114,RU=T?Symbol.for("react.provider"):60109,zU=T?Symbol.for("react.context"):60110,de=T?Symbol.for("react.async_mode"):60111,BU=T?Symbol.for("react.concurrent_mode"):60111,_U=T?Symbol.for("react.forward_ref"):60112,EU=T?Symbol.for("react.suspense"):60113,lf=T?Symbol.for("react.suspense_list"):60120,WU=T?Symbol.for("react.memo"):60115,HU=T?Symbol.for("react.lazy"):60116,pf=T?Symbol.for("react.block"):60121,uf=T?Symbol.for("react.fundamental"):60117,mf=T?Symbol.for("react.responder"):60118,gf=T?Symbol.for("react.scope"):60119;function _(U){if(typeof U=="object"&&U!==null){var e=U.$$typeof;switch(e){case ce:switch(U=U.type,U){case de:case BU:case MU:case AU:case OU:case EU:return U;default:switch(U=U&&U.$$typeof,U){case zU:case _U:case HU:case WU:case RU:return U;default:return e}}case te:return e}}}function Xe(U){return _(U)===BU}h.AsyncMode=de;h.ConcurrentMode=BU;h.ContextConsumer=zU;h.ContextProvider=RU;h.Element=ce;h.ForwardRef=_U;h.Fragment=MU;h.Lazy=HU;h.Memo=WU;h.Portal=te;h.Profiler=AU;h.StrictMode=OU;h.Suspense=EU;h.isAsyncMode=function(U){return Xe(U)||_(U)===de};h.isConcurrentMode=Xe;h.isContextConsumer=function(U){return _(U)===zU};h.isContextProvider=function(U){return _(U)===RU};h.isElement=function(U){return typeof U=="object"&&U!==null&&U.$$typeof===ce};h.isForwardRef=function(U){return _(U)===_U};h.isFragment=function(U){return _(U)===MU};h.isLazy=function(U){return _(U)===HU};h.isMemo=function(U){return _(U)===WU};h.isPortal=function(U){return _(U)===te};h.isProfiler=function(U){return _(U)===AU};h.isStrictMode=function(U){return _(U)===OU};h.isSuspense=function(U){return _(U)===EU};h.isValidElementType=function(U){return typeof U=="string"||typeof U=="function"||U===MU||U===BU||U===AU||U===OU||U===EU||U===lf||typeof U=="object"&&U!==null&&(U.$$typeof===HU||U.$$typeof===WU||U.$$typeof===RU||U.$$typeof===zU||U.$$typeof===_U||U.$$typeof===uf||U.$$typeof===mf||U.$$typeof===gf||U.$$typeof===pf)};h.typeOf=_;Ne.exports=h;var yf=Ne.exports,Ye=yf,hf={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},wf={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},Ze={};Ze[Ye.ForwardRef]=hf;Ze[Ye.Memo]=wf;var Pf=!0;function Ft(U,e,a){var f="";return a.split(" ").forEach(function(c){U[c]!==void 0?e.push(U[c]+";"):f+=c+" "}),f}var xf=function(e,a,f){var c=e.key+"-"+a.name;(f===!1||Pf===!1)&&e.registered[c]===void 0&&(e.registered[c]=a.styles)},vf=function(e,a,f){xf(e,a,f);var c=e.key+"-"+a.name;if(e.inserted[a.name]===void 0){var t=a;do e.insert(a===t?"."+c:"",t,e.sheet,!0),t=t.next;while(t!==void 0)}};function Vf(U){for(var e=0,a,f=0,c=U.length;c>=4;++f,c-=4)a=U.charCodeAt(f)&255|(U.charCodeAt(++f)&255)<<8|(U.charCodeAt(++f)&255)<<16|(U.charCodeAt(++f)&255)<<24,a=(a&65535)*1540483477+((a>>>16)*59797<<16),a^=a>>>24,e=(a&65535)*1540483477+((a>>>16)*59797<<16)^(e&65535)*1540483477+((e>>>16)*59797<<16);switch(c){case 3:e^=(U.charCodeAt(f+2)&255)<<16;case 2:e^=(U.charCodeAt(f+1)&255)<<8;case 1:e^=U.charCodeAt(f)&255,e=(e&65535)*1540483477+((e>>>16)*59797<<16)}return e^=e>>>13,e=(e&65535)*1540483477+((e>>>16)*59797<<16),((e^e>>>15)>>>0).toString(36)}var Jf={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},Sf=/[A-Z]|^ms/g,kf=/_EMO_([^_]+?)_([^]*?)_EMO_/g,Qe=function(e){return e.charCodeAt(1)===45},he=function(e){return e!=null&&typeof e!="boolean"},qU=Ba(function(U){return Qe(U)?U:U.replace(Sf,"-$&").toLowerCase()}),we=function(e,a){switch(e){case"animation":case"animationName":if(typeof a=="string")return a.replace(kf,function(f,c,t){return K={name:c,styles:t,next:K},c})}return Jf[e]!==1&&!Qe(e)&&typeof a=="number"&&a!==0?a+"px":a};function uU(U,e,a){if(a==null)return"";if(a.__emotion_styles!==void 0)return a;switch(typeof a){case"boolean":return"";case"object":{if(a.anim===1)return K={name:a.name,styles:a.styles,next:K},a.name;if(a.styles!==void 0){var f=a.next;if(f!==void 0)for(;f!==void 0;)K={name:f.name,styles:f.styles,next:K},f=f.next;var c=a.styles+";";return c}return $f(U,e,a)}case"function":{if(U!==void 0){var t=K,d=a(U);return K=t,uU(U,e,d)}break}}if(e==null)return a;var r=e[a];return r!==void 0?r:a}function $f(U,e,a){var f="";if(Array.isArray(a))for(var c=0;c<a.length;c++)f+=uU(U,e,a[c])+";";else for(var t in a){var d=a[t];if(typeof d!="object")e!=null&&e[d]!==void 0?f+=t+"{"+e[d]+"}":he(d)&&(f+=qU(t)+":"+we(t,d)+";");else if(Array.isArray(d)&&typeof d[0]=="string"&&(e==null||e[d[0]]===void 0))for(var r=0;r<d.length;r++)he(d[r])&&(f+=qU(t)+":"+we(t,d[r])+";");else{var o=uU(U,e,d);switch(t){case"animation":case"animationName":{f+=qU(t)+":"+o+";";break}default:f+=t+"{"+o+"}"}}}return f}var Pe=/label:\s*([^\s;\n{]+)\s*(;|$)/g,K,Ua=function(e,a,f){if(e.length===1&&typeof e[0]=="object"&&e[0]!==null&&e[0].styles!==void 0)return e[0];var c=!0,t="";K=void 0;var d=e[0];d==null||d.raw===void 0?(c=!1,t+=uU(f,a,d)):t+=d[0];for(var r=1;r<e.length;r++)t+=uU(f,a,e[r]),c&&(t+=d[r]);Pe.lastIndex=0;for(var o="",i;(i=Pe.exec(t))!==null;)o+="-"+i[1];var l=Vf(t)+o;return{name:l,styles:t,next:K}},ea=W.createContext(typeof HTMLElement<"u"?sf({key:"css"}):null),Gt=ea.Provider,Cf=function(e){return W.forwardRef(function(a,f){var c=W.useContext(ea);return e(a,c,f)})},re=W.createContext({});za();var Tf=Cf(function(U,e){var a=U.styles,f=Ua([a],void 0,W.useContext(re)),c=W.useRef();return le(function(){var t=e.key+"-global",d=new e.sheet.constructor({key:t,nonce:e.sheet.nonce,container:e.sheet.container,speedy:e.sheet.isSpeedy}),r=!1,o=document.querySelector('style[data-emotion="'+t+" "+f.name+'"]');return e.sheet.tags.length&&(d.before=e.sheet.tags[0]),o!==null&&(r=!0,o.setAttribute("data-emotion",t),d.hydrate([o])),c.current=[d,r],function(){d.flush()}},[e]),le(function(){var t=c.current,d=t[0],r=t[1];if(r){t[1]=!1;return}if(f.next!==void 0&&vf(e,f.next,!0),d.tags.length){var o=d.tags[d.tags.length-1].nextElementSibling;d.before=o,d.flush()}e.insert("",f,d,!1)},[e,f.name]),null});function Mf(){for(var U=arguments.length,e=new Array(U),a=0;a<U;a++)e[a]=arguments[a];return Ua(e)}var Dt=function(){var e=Mf.apply(void 0,arguments),a="animation-"+e.name;return{name:a,styles:"@keyframes "+a+"{"+e.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}};function Of(U){return U==null||Object.keys(U).length===0}function Af(U){const{styles:e,defaultTheme:a={}}=U;return q(Tf,{styles:typeof e=="function"?c=>e(Of(c)?a:c):e})}function fU(U){if(typeof U!="object"||U===null)return!1;const e=Object.getPrototypeOf(U);return(e===null||e===Object.prototype||Object.getPrototypeOf(e)===null)&&!(Symbol.toStringTag in U)&&!(Symbol.iterator in U)}function aa(U){if(!fU(U))return U;const e={};return Object.keys(U).forEach(a=>{e[a]=aa(U[a])}),e}function D(U,e,a={clone:!0}){const f=a.clone?g({},U):U;return fU(U)&&fU(e)&&Object.keys(e).forEach(c=>{c!=="__proto__"&&(fU(e[c])&&c in U&&fU(U[c])?f[c]=D(U[c],e[c],a):a.clone?f[c]=fU(e[c])?aa(e[c]):e[c]:f[c]=e[c])}),f}function fa(U){if(typeof U!="string")throw new Error(sU(7));return U.charAt(0).toUpperCase()+U.slice(1)}const Rf=["values","unit","step"],zf=U=>{const e=Object.keys(U).map(a=>({key:a,val:U[a]}))||[];return e.sort((a,f)=>a.val-f.val),e.reduce((a,f)=>g({},a,{[f.key]:f.val}),{})};function Bf(U){const{values:e={xs:0,sm:600,md:900,lg:1200,xl:1536},unit:a="px",step:f=5}=U,c=X(U,Rf),t=zf(e),d=Object.keys(t);function r(b){return`@media (min-width:${typeof e[b]=="number"?e[b]:b}${a})`}function o(b){return`@media (max-width:${(typeof e[b]=="number"?e[b]:b)-f/100}${a})`}function i(b,y){const p=d.indexOf(y);return`@media (min-width:${typeof e[b]=="number"?e[b]:b}${a}) and (max-width:${(p!==-1&&typeof e[d[p]]=="number"?e[d[p]]:y)-f/100}${a})`}function l(b){return d.indexOf(b)+1<d.length?i(b,d[d.indexOf(b)+1]):r(b)}function s(b){const y=d.indexOf(b);return y===0?r(d[1]):y===d.length-1?o(d[y]):i(b,d[d.indexOf(b)+1]).replace("@media","@media not all and")}return g({keys:d,values:t,up:r,down:o,between:i,only:l,not:s,unit:a},c)}const _f={borderRadius:4},Ef=_f;function iU(U,e){return e?D(U,e,{clone:!1}):U}const oe={xs:0,sm:600,md:900,lg:1200,xl:1536},xe={keys:["xs","sm","md","lg","xl"],up:U=>`@media (min-width:${oe[U]}px)`};function N(U,e,a){const f=U.theme||{};if(Array.isArray(e)){const t=f.breakpoints||xe;return e.reduce((d,r,o)=>(d[t.up(t.keys[o])]=a(e[o]),d),{})}if(typeof e=="object"){const t=f.breakpoints||xe;return Object.keys(e).reduce((d,r)=>{if(Object.keys(t.values||oe).indexOf(r)!==-1){const o=t.up(r);d[o]=a(e[r],r)}else{const o=r;d[o]=e[o]}return d},{})}return a(e)}function Wf(U={}){var e;return((e=U.keys)==null?void 0:e.reduce((f,c)=>{const t=U.up(c);return f[t]={},f},{}))||{}}function Hf(U,e){return U.reduce((a,f)=>{const c=a[f];return(!c||Object.keys(c).length===0)&&delete a[f],a},e)}function jf(U,e){if(typeof U!="object")return{};const a={},f=Object.keys(e);return Array.isArray(U)?f.forEach((c,t)=>{t<U.length&&(a[c]=!0)}):f.forEach(c=>{U[c]!=null&&(a[c]=!0)}),a}function qt({values:U,breakpoints:e,base:a}){const f=a||jf(U,e),c=Object.keys(f);if(c.length===0)return U;let t;return c.reduce((d,r,o)=>(Array.isArray(U)?(d[r]=U[o]!=null?U[o]:U[t],t=o):typeof U=="object"?(d[r]=U[r]!=null?U[r]:U[t],t=r):d[r]=U,d),{})}function jU(U,e,a=!0){if(!e||typeof e!="string")return null;if(U&&U.vars&&a){const f=`vars.${e}`.split(".").reduce((c,t)=>c&&c[t]?c[t]:null,U);if(f!=null)return f}return e.split(".").reduce((f,c)=>f&&f[c]!=null?f[c]:null,U)}function SU(U,e,a,f=a){let c;return typeof U=="function"?c=U(a):Array.isArray(U)?c=U[a]||f:c=jU(U,a)||f,e&&(c=e(c,f,U)),c}function $(U){const{prop:e,cssProperty:a=U.prop,themeKey:f,transform:c}=U,t=d=>{if(d[e]==null)return null;const r=d[e],o=d.theme,i=jU(o,f)||{};return N(d,r,s=>{let b=SU(i,c,s);return s===b&&typeof s=="string"&&(b=SU(i,c,`${e}${s==="default"?"":fa(s)}`,s)),a===!1?b:{[a]:b}})};return t.propTypes={},t.filterProps=[e],t}function If(U){const e={};return a=>(e[a]===void 0&&(e[a]=U(a)),e[a])}const Lf={m:"margin",p:"padding"},Kf={t:"Top",r:"Right",b:"Bottom",l:"Left",x:["Left","Right"],y:["Top","Bottom"]},ve={marginX:"mx",marginY:"my",paddingX:"px",paddingY:"py"},Ff=If(U=>{if(U.length>2)if(ve[U])U=ve[U];else return[U];const[e,a]=U.split(""),f=Lf[e],c=Kf[a]||"";return Array.isArray(c)?c.map(t=>f+t):[f+c]}),ne=["m","mt","mr","mb","ml","mx","my","margin","marginTop","marginRight","marginBottom","marginLeft","marginX","marginY","marginInline","marginInlineStart","marginInlineEnd","marginBlock","marginBlockStart","marginBlockEnd"],be=["p","pt","pr","pb","pl","px","py","padding","paddingTop","paddingRight","paddingBottom","paddingLeft","paddingX","paddingY","paddingInline","paddingInlineStart","paddingInlineEnd","paddingBlock","paddingBlockStart","paddingBlockEnd"];[...ne,...be];function yU(U,e,a,f){var c;const t=(c=jU(U,e,!1))!=null?c:a;return typeof t=="number"?d=>typeof d=="string"?d:t*d:Array.isArray(t)?d=>typeof d=="string"?d:t[d]:typeof t=="function"?t:()=>{}}function ca(U){return yU(U,"spacing",8)}function hU(U,e){if(typeof e=="string"||e==null)return e;const a=Math.abs(e),f=U(a);return e>=0?f:typeof f=="number"?-f:`-${f}`}function Gf(U,e){return a=>U.reduce((f,c)=>(f[c]=hU(e,a),f),{})}function Df(U,e,a,f){if(e.indexOf(a)===-1)return null;const c=Ff(a),t=Gf(c,f),d=U[a];return N(U,d,t)}function ta(U,e){const a=ca(U.theme);return Object.keys(U).map(f=>Df(U,e,f,a)).reduce(iU,{})}function V(U){return ta(U,ne)}V.propTypes={};V.filterProps=ne;function J(U){return ta(U,be)}J.propTypes={};J.filterProps=be;function qf(U=8){if(U.mui)return U;const e=ca({spacing:U}),a=(...f)=>(f.length===0?[1]:f).map(t=>{const d=e(t);return typeof d=="number"?`${d}px`:d}).join(" ");return a.mui=!0,a}function IU(...U){const e=U.reduce((f,c)=>(c.filterProps.forEach(t=>{f[t]=c}),f),{}),a=f=>Object.keys(f).reduce((c,t)=>e[t]?iU(c,e[t](f)):c,{});return a.propTypes={},a.filterProps=U.reduce((f,c)=>f.concat(c.filterProps),[]),a}function E(U){return typeof U!="number"?U:`${U}px solid`}function j(U,e){return $({prop:U,themeKey:"borders",transform:e})}const Nf=j("border",E),Xf=j("borderTop",E),Yf=j("borderRight",E),Zf=j("borderBottom",E),Qf=j("borderLeft",E),Uc=j("borderColor"),ec=j("borderTopColor"),ac=j("borderRightColor"),fc=j("borderBottomColor"),cc=j("borderLeftColor"),tc=j("outline",E),dc=j("outlineColor"),LU=U=>{if(U.borderRadius!==void 0&&U.borderRadius!==null){const e=yU(U.theme,"shape.borderRadius",4),a=f=>({borderRadius:hU(e,f)});return N(U,U.borderRadius,a)}return null};LU.propTypes={};LU.filterProps=["borderRadius"];IU(Nf,Xf,Yf,Zf,Qf,Uc,ec,ac,fc,cc,LU,tc,dc);const KU=U=>{if(U.gap!==void 0&&U.gap!==null){const e=yU(U.theme,"spacing",8),a=f=>({gap:hU(e,f)});return N(U,U.gap,a)}return null};KU.propTypes={};KU.filterProps=["gap"];const FU=U=>{if(U.columnGap!==void 0&&U.columnGap!==null){const e=yU(U.theme,"spacing",8),a=f=>({columnGap:hU(e,f)});return N(U,U.columnGap,a)}return null};FU.propTypes={};FU.filterProps=["columnGap"];const GU=U=>{if(U.rowGap!==void 0&&U.rowGap!==null){const e=yU(U.theme,"spacing",8),a=f=>({rowGap:hU(e,f)});return N(U,U.rowGap,a)}return null};GU.propTypes={};GU.filterProps=["rowGap"];const rc=$({prop:"gridColumn"}),oc=$({prop:"gridRow"}),nc=$({prop:"gridAutoFlow"}),bc=$({prop:"gridAutoColumns"}),ic=$({prop:"gridAutoRows"}),sc=$({prop:"gridTemplateColumns"}),lc=$({prop:"gridTemplateRows"}),pc=$({prop:"gridTemplateAreas"}),uc=$({prop:"gridArea"});IU(KU,FU,GU,rc,oc,nc,bc,ic,sc,lc,pc,uc);function tU(U,e){return e==="grey"?e:U}const mc=$({prop:"color",themeKey:"palette",transform:tU}),gc=$({prop:"bgcolor",cssProperty:"backgroundColor",themeKey:"palette",transform:tU}),yc=$({prop:"backgroundColor",themeKey:"palette",transform:tU});IU(mc,gc,yc);function z(U){return U<=1&&U!==0?`${U*100}%`:U}const hc=$({prop:"width",transform:z}),ie=U=>{if(U.maxWidth!==void 0&&U.maxWidth!==null){const e=a=>{var f,c;const t=((f=U.theme)==null||(f=f.breakpoints)==null||(f=f.values)==null?void 0:f[a])||oe[a];return t?((c=U.theme)==null||(c=c.breakpoints)==null?void 0:c.unit)!=="px"?{maxWidth:`${t}${U.theme.breakpoints.unit}`}:{maxWidth:t}:{maxWidth:z(a)}};return N(U,U.maxWidth,e)}return null};ie.filterProps=["maxWidth"];const wc=$({prop:"minWidth",transform:z}),Pc=$({prop:"height",transform:z}),xc=$({prop:"maxHeight",transform:z}),vc=$({prop:"minHeight",transform:z});$({prop:"size",cssProperty:"width",transform:z});$({prop:"size",cssProperty:"height",transform:z});const Vc=$({prop:"boxSizing"});IU(hc,ie,wc,Pc,xc,vc,Vc);const Jc={border:{themeKey:"borders",transform:E},borderTop:{themeKey:"borders",transform:E},borderRight:{themeKey:"borders",transform:E},borderBottom:{themeKey:"borders",transform:E},borderLeft:{themeKey:"borders",transform:E},borderColor:{themeKey:"palette"},borderTopColor:{themeKey:"palette"},borderRightColor:{themeKey:"palette"},borderBottomColor:{themeKey:"palette"},borderLeftColor:{themeKey:"palette"},outline:{themeKey:"borders",transform:E},outlineColor:{themeKey:"palette"},borderRadius:{themeKey:"shape.borderRadius",style:LU},color:{themeKey:"palette",transform:tU},bgcolor:{themeKey:"palette",cssProperty:"backgroundColor",transform:tU},backgroundColor:{themeKey:"palette",transform:tU},p:{style:J},pt:{style:J},pr:{style:J},pb:{style:J},pl:{style:J},px:{style:J},py:{style:J},padding:{style:J},paddingTop:{style:J},paddingRight:{style:J},paddingBottom:{style:J},paddingLeft:{style:J},paddingX:{style:J},paddingY:{style:J},paddingInline:{style:J},paddingInlineStart:{style:J},paddingInlineEnd:{style:J},paddingBlock:{style:J},paddingBlockStart:{style:J},paddingBlockEnd:{style:J},m:{style:V},mt:{style:V},mr:{style:V},mb:{style:V},ml:{style:V},mx:{style:V},my:{style:V},margin:{style:V},marginTop:{style:V},marginRight:{style:V},marginBottom:{style:V},marginLeft:{style:V},marginX:{style:V},marginY:{style:V},marginInline:{style:V},marginInlineStart:{style:V},marginInlineEnd:{style:V},marginBlock:{style:V},marginBlockStart:{style:V},marginBlockEnd:{style:V},displayPrint:{cssProperty:!1,transform:U=>({"@media print":{display:U}})},display:{},overflow:{},textOverflow:{},visibility:{},whiteSpace:{},flexBasis:{},flexDirection:{},flexWrap:{},justifyContent:{},alignItems:{},alignContent:{},order:{},flex:{},flexGrow:{},flexShrink:{},alignSelf:{},justifyItems:{},justifySelf:{},gap:{style:KU},rowGap:{style:GU},columnGap:{style:FU},gridColumn:{},gridRow:{},gridAutoFlow:{},gridAutoColumns:{},gridAutoRows:{},gridTemplateColumns:{},gridTemplateRows:{},gridTemplateAreas:{},gridArea:{},position:{},zIndex:{themeKey:"zIndex"},top:{},right:{},bottom:{},left:{},boxShadow:{themeKey:"shadows"},width:{transform:z},maxWidth:{style:ie},minWidth:{transform:z},height:{transform:z},maxHeight:{transform:z},minHeight:{transform:z},boxSizing:{},fontFamily:{themeKey:"typography"},fontSize:{themeKey:"typography"},fontStyle:{themeKey:"typography"},fontWeight:{themeKey:"typography"},letterSpacing:{},textTransform:{},lineHeight:{},textAlign:{},typography:{cssProperty:!1,themeKey:"typography"}},se=Jc;function Sc(...U){const e=U.reduce((f,c)=>f.concat(Object.keys(c)),[]),a=new Set(e);return U.every(f=>a.size===Object.keys(f).length)}function kc(U,e){return typeof U=="function"?U(e):U}function $c(){function U(a,f,c,t){const d={[a]:f,theme:c},r=t[a];if(!r)return{[a]:f};const{cssProperty:o=a,themeKey:i,transform:l,style:s}=r;if(f==null)return null;if(i==="typography"&&f==="inherit")return{[a]:f};const b=jU(c,i)||{};return s?s(d):N(d,f,p=>{let n=SU(b,l,p);return p===n&&typeof p=="string"&&(n=SU(b,l,`${a}${p==="default"?"":fa(p)}`,p)),o===!1?n:{[o]:n}})}function e(a){var f;const{sx:c,theme:t={}}=a||{};if(!c)return null;const d=(f=t.unstable_sxConfig)!=null?f:se;function r(o){let i=o;if(typeof o=="function")i=o(t);else if(typeof o!="object")return o;if(!i)return null;const l=Wf(t.breakpoints),s=Object.keys(l);let b=l;return Object.keys(i).forEach(y=>{const p=kc(i[y],t);if(p!=null)if(typeof p=="object")if(d[y])b=iU(b,U(y,p,t,d));else{const n=N({theme:t},p,x=>({[y]:x}));Sc(n,p)?b[y]=e({sx:p,theme:t}):b=iU(b,n)}else b=iU(b,U(y,p,t,d))}),Hf(s,b)}return Array.isArray(c)?c.map(r):r(c)}return e}const da=$c();da.filterProps=["sx"];const ra=da;function Cc(U,e){const a=this;return a.vars&&typeof a.getColorSchemeSelector=="function"?{[a.getColorSchemeSelector(U).replace(/(\[[^\]]+\])/,"*:where($1)")]:e}:a.palette.mode===U?e:{}}const Tc=["breakpoints","palette","spacing","shape"];function oa(U={},...e){const{breakpoints:a={},palette:f={},spacing:c,shape:t={}}=U,d=X(U,Tc),r=Bf(a),o=qf(c);let i=D({breakpoints:r,direction:"ltr",components:{},palette:g({mode:"light"},f),spacing:o,shape:g({},Ef,t)},d);return i.applyStyles=Cc,i=e.reduce((l,s)=>D(l,s),i),i.unstable_sxConfig=g({},se,d==null?void 0:d.unstable_sxConfig),i.unstable_sx=function(s){return ra({sx:s,theme:this})},i}function Mc(U,e){return g({toolbar:{minHeight:56,[U.up("xs")]:{"@media (orientation: landscape)":{minHeight:48}},[U.up("sm")]:{minHeight:64}}},e)}const Oc={black:"#000",white:"#fff"},mU=Oc,Ac={50:"#fafafa",100:"#f5f5f5",200:"#eeeeee",300:"#e0e0e0",400:"#bdbdbd",500:"#9e9e9e",600:"#757575",700:"#616161",800:"#424242",900:"#212121",A100:"#f5f5f5",A200:"#eeeeee",A400:"#bdbdbd",A700:"#616161"},Rc=Ac,zc={50:"#f3e5f5",100:"#e1bee7",200:"#ce93d8",300:"#ba68c8",400:"#ab47bc",500:"#9c27b0",600:"#8e24aa",700:"#7b1fa2",800:"#6a1b9a",900:"#4a148c",A100:"#ea80fc",A200:"#e040fb",A400:"#d500f9",A700:"#aa00ff"},Z=zc,Bc={50:"#ffebee",100:"#ffcdd2",200:"#ef9a9a",300:"#e57373",400:"#ef5350",500:"#f44336",600:"#e53935",700:"#d32f2f",800:"#c62828",900:"#b71c1c",A100:"#ff8a80",A200:"#ff5252",A400:"#ff1744",A700:"#d50000"},Q=Bc,_c={50:"#fff3e0",100:"#ffe0b2",200:"#ffcc80",300:"#ffb74d",400:"#ffa726",500:"#ff9800",600:"#fb8c00",700:"#f57c00",800:"#ef6c00",900:"#e65100",A100:"#ffd180",A200:"#ffab40",A400:"#ff9100",A700:"#ff6d00"},bU=_c,Ec={50:"#e3f2fd",100:"#bbdefb",200:"#90caf9",300:"#64b5f6",400:"#42a5f5",500:"#2196f3",600:"#1e88e5",700:"#1976d2",800:"#1565c0",900:"#0d47a1",A100:"#82b1ff",A200:"#448aff",A400:"#2979ff",A700:"#2962ff"},UU=Ec,Wc={50:"#e1f5fe",100:"#b3e5fc",200:"#81d4fa",300:"#4fc3f7",400:"#29b6f6",500:"#03a9f4",600:"#039be5",700:"#0288d1",800:"#0277bd",900:"#01579b",A100:"#80d8ff",A200:"#40c4ff",A400:"#00b0ff",A700:"#0091ea"},eU=Wc,Hc={50:"#e8f5e9",100:"#c8e6c9",200:"#a5d6a7",300:"#81c784",400:"#66bb6a",500:"#4caf50",600:"#43a047",700:"#388e3c",800:"#2e7d32",900:"#1b5e20",A100:"#b9f6ca",A200:"#69f0ae",A400:"#00e676",A700:"#00c853"},aU=Hc,jc=["mode","contrastThreshold","tonalOffset"],Ve={text:{primary:"rgba(0, 0, 0, 0.87)",secondary:"rgba(0, 0, 0, 0.6)",disabled:"rgba(0, 0, 0, 0.38)"},divider:"rgba(0, 0, 0, 0.12)",background:{paper:mU.white,default:mU.white},action:{active:"rgba(0, 0, 0, 0.54)",hover:"rgba(0, 0, 0, 0.04)",hoverOpacity:.04,selected:"rgba(0, 0, 0, 0.08)",selectedOpacity:.08,disabled:"rgba(0, 0, 0, 0.26)",disabledBackground:"rgba(0, 0, 0, 0.12)",disabledOpacity:.38,focus:"rgba(0, 0, 0, 0.12)",focusOpacity:.12,activatedOpacity:.12}},NU={text:{primary:mU.white,secondary:"rgba(255, 255, 255, 0.7)",disabled:"rgba(255, 255, 255, 0.5)",icon:"rgba(255, 255, 255, 0.5)"},divider:"rgba(255, 255, 255, 0.12)",background:{paper:"#121212",default:"#121212"},action:{active:mU.white,hover:"rgba(255, 255, 255, 0.08)",hoverOpacity:.08,selected:"rgba(255, 255, 255, 0.16)",selectedOpacity:.16,disabled:"rgba(255, 255, 255, 0.3)",disabledBackground:"rgba(255, 255, 255, 0.12)",disabledOpacity:.38,focus:"rgba(255, 255, 255, 0.12)",focusOpacity:.12,activatedOpacity:.24}};function Je(U,e,a,f){const c=f.light||f,t=f.dark||f*1.5;U[e]||(U.hasOwnProperty(a)?U[e]=U[a]:e==="light"?U.light=Va(U.main,c):e==="dark"&&(U.dark=xa(U.main,t)))}function Ic(U="light"){return U==="dark"?{main:UU[200],light:UU[50],dark:UU[400]}:{main:UU[700],light:UU[400],dark:UU[800]}}function Lc(U="light"){return U==="dark"?{main:Z[200],light:Z[50],dark:Z[400]}:{main:Z[500],light:Z[300],dark:Z[700]}}function Kc(U="light"){return U==="dark"?{main:Q[500],light:Q[300],dark:Q[700]}:{main:Q[700],light:Q[400],dark:Q[800]}}function Fc(U="light"){return U==="dark"?{main:eU[400],light:eU[300],dark:eU[700]}:{main:eU[700],light:eU[500],dark:eU[900]}}function Gc(U="light"){return U==="dark"?{main:aU[400],light:aU[300],dark:aU[700]}:{main:aU[800],light:aU[500],dark:aU[900]}}function Dc(U="light"){return U==="dark"?{main:bU[400],light:bU[300],dark:bU[700]}:{main:"#ed6c02",light:bU[500],dark:bU[900]}}function qc(U){const{mode:e="light",contrastThreshold:a=3,tonalOffset:f=.2}=U,c=X(U,jc),t=U.primary||Ic(e),d=U.secondary||Lc(e),r=U.error||Kc(e),o=U.info||Fc(e),i=U.success||Gc(e),l=U.warning||Dc(e);function s(n){return va(n,NU.text.primary)>=a?NU.text.primary:Ve.text.primary}const b=({color:n,name:x,mainShade:w=500,lightShade:S=300,darkShade:A=700})=>{if(n=g({},n),!n.main&&n[w]&&(n.main=n[w]),!n.hasOwnProperty("main"))throw new Error(sU(11,x?` (${x})`:"",w));if(typeof n.main!="string")throw new Error(sU(12,x?` (${x})`:"",JSON.stringify(n.main)));return Je(n,"light",S,f),Je(n,"dark",A,f),n.contrastText||(n.contrastText=s(n.main)),n},y={dark:NU,light:Ve};return D(g({common:g({},mU),mode:e,primary:b({color:t,name:"primary"}),secondary:b({color:d,name:"secondary",mainShade:"A400",lightShade:"A200",darkShade:"A700"}),error:b({color:r,name:"error"}),warning:b({color:l,name:"warning"}),info:b({color:o,name:"info"}),success:b({color:i,name:"success"}),grey:Rc,contrastThreshold:a,getContrastText:s,augmentColor:b,tonalOffset:f},y[e]),c)}const Nc=["fontFamily","fontSize","fontWeightLight","fontWeightRegular","fontWeightMedium","fontWeightBold","htmlFontSize","allVariants","pxToRem"];function Xc(U){return Math.round(U*1e5)/1e5}const Se={textTransform:"uppercase"},ke='"Roboto", "Helvetica", "Arial", sans-serif';function Yc(U,e){const a=typeof e=="function"?e(U):e,{fontFamily:f=ke,fontSize:c=14,fontWeightLight:t=300,fontWeightRegular:d=400,fontWeightMedium:r=500,fontWeightBold:o=700,htmlFontSize:i=16,allVariants:l,pxToRem:s}=a,b=X(a,Nc),y=c/14,p=s||(w=>`${w/i*y}rem`),n=(w,S,A,Y,G)=>g({fontFamily:f,fontWeight:w,fontSize:p(S),lineHeight:A},f===ke?{letterSpacing:`${Xc(Y/S)}em`}:{},G,l),x={h1:n(t,96,1.167,-1.5),h2:n(t,60,1.2,-.5),h3:n(d,48,1.167,0),h4:n(d,34,1.235,.25),h5:n(d,24,1.334,0),h6:n(r,20,1.6,.15),subtitle1:n(d,16,1.75,.15),subtitle2:n(r,14,1.57,.1),body1:n(d,16,1.5,.15),body2:n(d,14,1.43,.15),button:n(r,14,1.75,.4,Se),caption:n(d,12,1.66,.4),overline:n(d,12,2.66,1,Se),inherit:{fontFamily:"inherit",fontWeight:"inherit",fontSize:"inherit",lineHeight:"inherit",letterSpacing:"inherit"}};return D(g({htmlFontSize:i,pxToRem:p,fontFamily:f,fontSize:c,fontWeightLight:t,fontWeightRegular:d,fontWeightMedium:r,fontWeightBold:o},x),b,{clone:!1})}const Zc=.2,Qc=.14,Ut=.12;function v(...U){return[`${U[0]}px ${U[1]}px ${U[2]}px ${U[3]}px rgba(0,0,0,${Zc})`,`${U[4]}px ${U[5]}px ${U[6]}px ${U[7]}px rgba(0,0,0,${Qc})`,`${U[8]}px ${U[9]}px ${U[10]}px ${U[11]}px rgba(0,0,0,${Ut})`].join(",")}const et=["none",v(0,2,1,-1,0,1,1,0,0,1,3,0),v(0,3,1,-2,0,2,2,0,0,1,5,0),v(0,3,3,-2,0,3,4,0,0,1,8,0),v(0,2,4,-1,0,4,5,0,0,1,10,0),v(0,3,5,-1,0,5,8,0,0,1,14,0),v(0,3,5,-1,0,6,10,0,0,1,18,0),v(0,4,5,-2,0,7,10,1,0,2,16,1),v(0,5,5,-3,0,8,10,1,0,3,14,2),v(0,5,6,-3,0,9,12,1,0,3,16,2),v(0,6,6,-3,0,10,14,1,0,4,18,3),v(0,6,7,-4,0,11,15,1,0,4,20,3),v(0,7,8,-4,0,12,17,2,0,5,22,4),v(0,7,8,-4,0,13,19,2,0,5,24,4),v(0,7,9,-4,0,14,21,2,0,5,26,4),v(0,8,9,-5,0,15,22,2,0,6,28,5),v(0,8,10,-5,0,16,24,2,0,6,30,5),v(0,8,11,-5,0,17,26,2,0,6,32,5),v(0,9,11,-5,0,18,28,2,0,7,34,6),v(0,9,12,-6,0,19,29,2,0,7,36,6),v(0,10,13,-6,0,20,31,3,0,8,38,7),v(0,10,13,-6,0,21,33,3,0,8,40,7),v(0,10,14,-6,0,22,35,3,0,8,42,7),v(0,11,14,-7,0,23,36,3,0,9,44,8),v(0,11,15,-7,0,24,38,3,0,9,46,8)],at=et,ft=["duration","easing","delay"],ct={easeInOut:"cubic-bezier(0.4, 0, 0.2, 1)",easeOut:"cubic-bezier(0.0, 0, 0.2, 1)",easeIn:"cubic-bezier(0.4, 0, 1, 1)",sharp:"cubic-bezier(0.4, 0, 0.6, 1)"},tt={shortest:150,shorter:200,short:250,standard:300,complex:375,enteringScreen:225,leavingScreen:195};function $e(U){return`${Math.round(U)}ms`}function dt(U){if(!U)return 0;const e=U/36;return Math.round((4+15*e**.25+e/5)*10)}function rt(U){const e=g({},ct,U.easing),a=g({},tt,U.duration);return g({getAutoHeightDuration:dt,create:(c=["all"],t={})=>{const{duration:d=a.standard,easing:r=e.easeInOut,delay:o=0}=t;return X(t,ft),(Array.isArray(c)?c:[c]).map(i=>`${i} ${typeof d=="string"?d:$e(d)} ${r} ${typeof o=="string"?o:$e(o)}`).join(",")}},U,{easing:e,duration:a})}const ot={mobileStepper:1e3,fab:1050,speedDial:1050,appBar:1100,drawer:1200,modal:1300,snackbar:1400,tooltip:1500},nt=ot,bt=["breakpoints","mixins","spacing","palette","transitions","typography","shape"];function na(U={},...e){const{mixins:a={},palette:f={},transitions:c={},typography:t={}}=U,d=X(U,bt);if(U.vars)throw new Error(sU(18));const r=qc(f),o=oa(U);let i=D(o,{mixins:Mc(o.breakpoints,a),palette:r,shadows:at.slice(),typography:Yc(r,t),transitions:rt(c),zIndex:g({},nt)});return i=D(i,d),i=e.reduce((l,s)=>D(l,s),i),i.unstable_sxConfig=g({},se,d==null?void 0:d.unstable_sxConfig),i.unstable_sx=function(s){return ra({sx:s,theme:this})},i}const it=na(),ba=it,kU="$$material";function st(U){const{theme:e,name:a,props:f}=U;return!e||!e.components||!e.components[a]||!e.components[a].defaultProps?f:Re(e.components[a].defaultProps,f)}function lt(U){return Object.keys(U).length===0}function ia(U=null){const e=W.useContext(re);return!e||lt(e)?U:e}const pt=oa();function sa(U=pt){return ia(U)}function ut({props:U,name:e,defaultTheme:a,themeId:f}){let c=sa(a);return f&&(c=c[f]||c),st({theme:c,name:e,props:U})}function mt({props:U,name:e}){return ut({props:U,name:e,defaultTheme:ba,themeId:kU})}function gt({styles:U,themeId:e,defaultTheme:a={}}){const f=sa(a),c=typeof U=="function"?U(e&&f[e]||f):U;return q(Af,{styles:c})}const yt=W.createContext(null),la=yt;function pa(){return W.useContext(la)}const ht=typeof Symbol=="function"&&Symbol.for,wt=ht?Symbol.for("mui.nested"):"__THEME_NESTED__";function Pt(U,e){return typeof e=="function"?e(U):g({},U,e)}function xt(U){const{children:e,theme:a}=U,f=pa(),c=W.useMemo(()=>{const t=f===null?a:Pt(f,a);return t!=null&&(t[wt]=f!==null),t},[a,f]);return q(la.Provider,{value:c,children:e})}const Ce={};function Te(U,e,a,f=!1){return W.useMemo(()=>{const c=U&&e[U]||e;if(typeof a=="function"){const t=a(c),d=U?g({},e,{[U]:t}):t;return f?()=>d:d}return U?g({},e,{[U]:a}):g({},e,a)},[U,e,a,f])}function vt(U){const{children:e,theme:a,themeId:f}=U,c=ia(Ce),t=pa()||Ce,d=Te(f,c,a),r=Te(f,t,a,!0);return q(xt,{theme:r,children:q(re.Provider,{value:d,children:e})})}const Vt=["theme"];function Jt(U){let{theme:e}=U,a=X(U,Vt);const f=e[kU];return q(vt,g({},a,{themeId:f?kU:void 0,theme:f||e}))}function St(U){return q(gt,g({},U,{defaultTheme:ba,themeId:kU}))}const kt=(U,e)=>g({WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale",boxSizing:"border-box",WebkitTextSizeAdjust:"100%"},e&&!U.vars&&{colorScheme:U.palette.mode}),$t=U=>g({color:(U.vars||U).palette.text.primary},U.typography.body1,{backgroundColor:(U.vars||U).palette.background.default,"@media print":{backgroundColor:(U.vars||U).palette.common.white}}),Ct=(U,e=!1)=>{var a;const f={};e&&U.colorSchemes&&Object.entries(U.colorSchemes).forEach(([d,r])=>{var o;f[U.getColorSchemeSelector(d).replace(/\s*&/,"")]={colorScheme:(o=r.palette)==null?void 0:o.mode}});let c=g({html:kt(U,e),"*, *::before, *::after":{boxSizing:"inherit"},"strong, b":{fontWeight:U.typography.fontWeightBold},body:g({margin:0},$t(U),{"&::backdrop":{backgroundColor:(U.vars||U).palette.background.default}})},f);const t=(a=U.components)==null||(a=a.MuiCssBaseline)==null?void 0:a.styleOverrides;return t&&(c=[c,t]),c};function Tt(U){const e=mt({props:U,name:"MuiCssBaseline"}),{children:a,enableColorScheme:f=!1}=e;return Oe(W.Fragment,{children:[q(St,{styles:c=>Ct(c,f)}),a]})}const Mt={"typography/headline/h1/black":{fontSize:"40px",fontWeight:800,lineHeight:"56px"},"typography/headline/h1/bold":{fontSize:"40px",fontWeight:700,lineHeight:"56px"},"typography/headline/h1/medium":{fontSize:"40px",fontWeight:600,lineHeight:"56px"},"typography/headline/h1/regular":{fontSize:"40px",fontWeight:400,lineHeight:"56px"},"typography/headline/h2/black":{fontSize:"36px",fontWeight:800,lineHeight:"48px"},"typography/headline/h2/bold":{fontSize:"36px",fontWeight:700,lineHeight:"48px"},"typography/headline/h2/medium":{fontSize:"36px",fontWeight:600,lineHeight:"48px"},"typography/headline/h2/regular":{fontSize:"36px",fontWeight:400,lineHeight:"48px"},"typography/headline/h3/black":{fontSize:"32px",fontWeight:800,lineHeight:"42px"},"typography/headline/h3/bold":{fontSize:"32px",fontWeight:700,lineHeight:"42px"},"typography/headline/h3/medium":{fontSize:"32px",fontWeight:600,lineHeight:"42px"},"typography/headline/h3/regular":{fontSize:"32px",fontWeight:400,lineHeight:"42px"},"typography/headline/h4/black":{fontSize:"30px",fontWeight:800,lineHeight:"40px"},"typography/headline/h4/bold":{fontSize:"30px",fontWeight:700,lineHeight:"40px"},"typography/headline/h4/medium":{fontSize:"30px",fontWeight:600,lineHeight:"40px"},"typography/headline/h4/regular":{fontSize:"30px",fontWeight:400,lineHeight:"40px"},"typography/title/large/black":{fontSize:"28px",fontWeight:900,lineHeight:"36px"},"typography/title/large/bold":{fontSize:"28px",fontWeight:700,lineHeight:"36px"},"typography/title/large/medium":{fontSize:"28px",fontWeight:400,lineHeight:"36px"},"typography/title/large/regular":{fontSize:"28px",fontWeight:400,lineHeight:"36px"},"typography/title/medium/black":{fontSize:"24px",fontWeight:800,lineHeight:"32px"},"typography/title/medium/bold":{fontSize:"24px",fontWeight:700,lineHeight:"32px"},"typography/title/medium/medium":{fontSize:"24px",fontWeight:600,lineHeight:"32px"},"typography/title/medium/regular":{fontSize:"24px",fontWeight:400,lineHeight:"32px"},"typography/title/small/black":{fontSize:"20px",fontWeight:900,lineHeight:"28px"},"typography/title/small/bold":{fontSize:"20px",fontWeight:700,lineHeight:"28px"},"typography/title/small/medium":{fontSize:"20px",fontWeight:600,lineHeight:"28px"},"typography/title/small/regular":{fontSize:"20px",fontWeight:400,lineHeight:"28px"},"typography/body/medium/black":{fontSize:"16px",fontWeight:800,lineHeight:"24px"},"typography/body/medium/bold":{fontSize:"16px",fontWeight:700,lineHeight:"24px"},"typography/body/medium/medium":{fontSize:"16px",fontWeight:600,lineHeight:"24px"},"typography/body/medium/regular":{fontSize:"16px",fontWeight:400,lineHeight:"24px"},"typography/body/small/black":{fontSize:"14px",fontWeight:800,lineHeight:"20px"},"typography/body/small/bold":{fontSize:"14px",fontWeight:700,lineHeight:"20px"},"typography/body/small/medium":{fontSize:"14px",fontWeight:600,lineHeight:"20px"},"typography/body/small/regular":{fontSize:"14px",fontWeight:400,lineHeight:"20px"},"typography/label/large/black":{fontSize:"12px",fontWeight:800,lineHeight:"16px"},"typography/label/large/bold":{fontSize:"12px",fontWeight:700,lineHeight:"16px"},"typography/label/large/medium":{fontSize:"12px",fontWeight:600,lineHeight:"16px"},"typography/label/large/regular":{fontSize:"12px",fontWeight:400,lineHeight:"16px"},"typography/label/medium/black":{fontSize:"11px",fontWeight:800,lineHeight:"14px"},"typography/label/medium/bold":{fontSize:"11px",fontWeight:700,lineHeight:"14px"},"typography/label/medium/medium":{fontSize:"11px",fontWeight:600,lineHeight:"14px"},"typography/label/medium/regular":{fontSize:"11px",fontWeight:400,lineHeight:"14px"},"typography/label/small/black":{fontSize:"10px",fontWeight:800,lineHeight:"14px"},"typography/label/small/bold":{fontSize:"10px",fontWeight:700,lineHeight:"14px"},"typography/label/small/medium":{fontSize:"10px",fontWeight:600,lineHeight:"14px"},"typography/label/small/regular":{fontSize:"10px",fontWeight:400,lineHeight:"14px"}},Ot=`
